...
Defines the annotations that generated and hand-written model classes use to declare metadata.

## Architectural Role

OA annotation contract
...
OAAnnotationVerifier, OACalculatedProperty, OAClass, OAClassFilter, OAColumn, OAFkey, OAId, OAIndex, OAIndexColumn, OALinkTable, OAMany, OAMethod, OAObjCallback, OAOne, OAProperty, OATable, OATriggerMethod
...
### INV-PKG-ANNOTATION-001: Metadata names are canonical runtime names
...
### INV-PKG-ANNOTATION-002: Metadata is configured before runtime use
