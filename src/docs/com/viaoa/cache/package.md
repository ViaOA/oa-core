...
Maintains canonical object cache views, indexes, listeners, and cache-to-Hub adapters.
...
OACacheListenerUtil, OAObjectCache, OAObjectCacheFilter, OAObjectCacheHubAdder, OAObjectCacheListener, OAObjectCacheTrigger, OAObjectIndex, OAObjectIndexKey
...
### INV-PKG-CACHE-001: Public contracts remain deterministic
...
Package classes: OACacheListenerUtil, OAObjectCache, OAObjectCacheFilter, OAObjectCacheHubAdder, OAObjectCacheListener, OAObjectCacheTrigger, OAObjectIndex, OAObjectIndexKey
...
### INV-PKG-CACHE-002: Shared mutable state is explicit
