...
Provides OA runtime support types for the com.viaoa.cascade package.
...
### INV-PKG-CASCADE-001: Public contracts remain deterministic
...
### INV-PKG-CASCADE-002: Shared mutable state is explicit
