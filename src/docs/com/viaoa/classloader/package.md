# com.viaoa.classloader

## Purpose

Provides OA runtime support types for the com.viaoa.classloader package.
...
ClassModifier, OAClassLoader, OAClassUtil
...
### INV-PKG-CLASSLOADER-001: Public contracts remain deterministic
...
Package classes: ClassModifier, OAClassLoader, OAClassUtil
...
### INV-PKG-CLASSLOADER-002: Shared mutable state is explicit
