...
Provides OA runtime support types for the com.viaoa.comm.io package.
...
### INV-PKG-COMM-IO-001: Public contracts remain deterministic
...
Package classes: IODummy, OAObjectInputStream
...
### INV-PKG-COMM-IO-002: Shared mutable state is explicit
