...
Provides OA runtime support types for the com.viaoa.comm.multiplexer.io package.
...
MultiplexerInputStreamController, MultiplexerOutputStreamController, MultiplexerServerSocketController, MultiplexerSocketController, VirtualServerSocket, VirtualSocket
...
### INV-PKG-COMM-MULTIPLEXER-IO-001: Public contracts remain deterministic
...
Package classes: MultiplexerInputStreamController, MultiplexerOutputStreamController, MultiplexerServerSocketController, MultiplexerSocketController, VirtualServerSocket, VirtualSocket
...
### INV-PKG-COMM-MULTIPLEXER-IO-002: Shared mutable state is explicit
