...
Provides OA runtime support types for the com.viaoa.comm.multiplexer package.
...
OAMultiplexerClient, OAMultiplexerServer

## Package-Level Invariants

### INV-PKG-COMM-MULTIPLEXER-001: Public contracts remain deterministic
...
Package classes: OAMultiplexerClient, OAMultiplexerServer
...
### INV-PKG-COMM-MULTIPLEXER-002: Shared mutable state is explicit
