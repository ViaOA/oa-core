...
Provides OA runtime support types for the com.viaoa.comm.ssl package.
...
OASslBase, OASslClient, OASslServer

## Package-Level Invariants

### INV-PKG-COMM-SSL-001: Public contracts remain deterministic
...
Package classes: OASslBase, OASslClient, OASslServer
...
### INV-PKG-COMM-SSL-002: Shared mutable state is explicit
