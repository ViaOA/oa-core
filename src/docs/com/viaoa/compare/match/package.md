...
Defines comparison and match semantics used by filters, queries, and UI rules.
...
OAMatch, OAMatchAny, OAMatchEmpty, OAMatchGreaterThanZero, OAMatchLessThanZero, OAMatchNotEmpty, OAMatchNotExist, OAMatchNotNull, OAMatchNull, OAMatchUnknown
...
### INV-PKG-COMPARE-MATCH-001: Public contracts remain deterministic
...
Package classes: OAMatch, OAMatchAny, OAMatchEmpty, OAMatchGreaterThanZero, OAMatchLessThanZero, OAMatchNotEmpty, OAMatchNotExist, OAMatchNotNull, OAMatchNull, OAMatchUnknown
...
### INV-PKG-COMPARE-MATCH-002: Shared mutable state is explicit
