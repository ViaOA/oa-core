...
OAComparator, OACompare, OAObjectCompare
...
### INV-PKG-COMPARE-001: Public contracts remain deterministic
...
Package classes: OAComparator, OACompare, OAObjectCompare
...
### INV-PKG-COMPARE-002: Shared mutable state is explicit
