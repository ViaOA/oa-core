...
Defines executor, pool, throttle, and scheduling wrappers used by OA services.
...
OAConcurrent, OAExecutorService, OAPool, OAScheduledExecutorService, OAThrottle
...
### INV-PKG-CONCURRENT-001: Public contracts remain deterministic
...
Package classes: OAConcurrent, OAExecutorService, OAPool, OAScheduledExecutorService, OAThrottle
...
### INV-PKG-CONCURRENT-002: Shared mutable state is explicit
