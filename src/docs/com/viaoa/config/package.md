...
Provides OA runtime support types for the com.viaoa.config package.
...
### INV-PKG-CONFIG-001: Public contracts remain deterministic
...
### INV-PKG-CONFIG-002: Shared mutable state is explicit
