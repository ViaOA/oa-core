...
### INV-PKG-DATASOURCE-AUTONUMBER-001: Datasource operations are model-class scoped
...
### INV-PKG-DATASOURCE-AUTONUMBER-002: Iterators must release datasource resources
