...
Defines OA-specific date, time, datetime, timezone, and range cache behavior.
...
OADate, OADateTime, OATime, OATimeZone
...
### INV-PKG-DATETIME-001: Public contracts remain deterministic
...
Package classes: OADate, OADateTime, OATime, OATimeZone
...
### INV-PKG-DATETIME-002: Shared mutable state is explicit
