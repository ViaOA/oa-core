...
Defines reusable predicates for values, paths, selects, and composite conditions.
...
OAAndFilter, OABetweenFilter, OABetweenOrEqualFilter, OABlockFilter, OAContainsFilter, OAEmptyFilter, OAEqualFilter, OAEqualPathFilter, OAFalseFilter, OAFilter, OAFilterDelegate, OAFindNull, OAGreaterFilter, OAGreaterOrEqualFilter, OAInFilter, OAIndexOfFilter, OALessFilter, OALessOrEqualFilter
...
### INV-PKG-FILTER-001: Public contracts remain deterministic
...
Package classes: OAAndFilter, OABetweenFilter, OABetweenOrEqualFilter, OABlockFilter, OAContainsFilter, OAEmptyFilter, OAEqualFilter, OAEqualPathFilter, OAFalseFilter, OAFilter
...
### INV-PKG-FILTER-002: Shared mutable state is explicit
