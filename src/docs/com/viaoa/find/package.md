...
Defines path and hierarchy finders over OAObject and Hub structures.
...
### INV-PKG-FIND-001: Public contracts remain deterministic
...
Package classes: OAFinder, OAHierFinder
...
### INV-PKG-FIND-002: Shared mutable state is explicit
