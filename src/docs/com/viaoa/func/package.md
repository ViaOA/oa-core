...
Provides OA runtime support types for the com.viaoa.func package.
...
### INV-PKG-FUNC-001: Public contracts remain deterministic
...
Package classes: OAFunction, StringCallback
...
### INV-PKG-FUNC-002: Shared mutable state is explicit
