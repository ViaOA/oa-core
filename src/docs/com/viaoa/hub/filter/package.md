...
CustomHubFilter, FilteredHub, HubFilter, HubMinusHubFilter
...
### INV-PKG-HUB-FILTER-001: Hub membership changes are observable
...
### INV-PKG-HUB-FILTER-002: Active object is independent collection state
