...
Hub, HubData, HubDataActive, HubDataMaster, HubDataUnique, HubDataUniquex, HubDatax, HubEvent, HubInternalBridge, HubListener, HubListenerAdapter, HubOnEventInterface, HubValidateListener
...
### INV-PKG-HUB-001: Hub membership changes are observable
...
### INV-PKG-HUB-002: Active object is independent collection state
