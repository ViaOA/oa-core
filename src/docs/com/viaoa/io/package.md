...
Provides OA runtime support types for the com.viaoa.io package.
...
OACompressWrapper, OAFile, OAFindFile
...
### INV-PKG-IO-001: Public contracts remain deterministic
...
Package classes: OACompressWrapper, OAFile, OAFindFile
...
### INV-PKG-IO-002: Shared mutable state is explicit
