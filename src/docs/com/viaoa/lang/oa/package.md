...
Defines core string, array, tuple, primitive wrapper, enum, and sizing helpers.
...
VBoolean, VDate, VDateTime, VDouble, VEnum, VInteger, VLong, VNameValue, VString, VTime
...
### INV-PKG-LANG-OA-001: Public contracts remain deterministic
...
Package classes: VBoolean, VDate, VDateTime, VDouble, VEnum, VInteger, VLong, VNameValue, VString, VTime
...
### INV-PKG-LANG-OA-002: Shared mutable state is explicit
