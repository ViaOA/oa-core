...
Provides OA runtime support types for the com.viaoa.load package.
...
### INV-PKG-LOAD-001: Public contracts remain deterministic
...
Package classes: OALoader, OAPreLoader
...
### INV-PKG-LOAD-002: Shared mutable state is explicit
