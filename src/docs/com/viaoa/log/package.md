...
Provides OA runtime support types for the com.viaoa.log package.
...
OALogRecord, OALogUtil, OALogger
...
### INV-PKG-LOG-001: Public contracts remain deterministic
...
Package classes: OALogRecord, OALogUtil, OALogger
...
### INV-PKG-LOG-002: Shared mutable state is explicit
