...
Provides OA runtime support types for the com.viaoa.math package.
...
### INV-PKG-MATH-001: Public contracts remain deterministic
...
### INV-PKG-MATH-002: Shared mutable state is explicit
