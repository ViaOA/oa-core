...
Defines internal Hub-service contracts used by OA runtime implementations.

## Architectural Role

Internal Hub operations API
...
HubAOOps, HubAddRemoveOps, HubAutoMatchOps, HubCSOps, HubCombineOps, HubCopyOps, HubDataOps, HubDeleteOps, HubDetailOps, HubEventOps, HubFilterOps, HubFindOps, HubLinkOps, HubMergeOps, HubPropertyOps, HubRootOps, HubSaveOps, HubSelectOps
...
### INV-PKG-OA-API-INTERNAL-HUBS-001: Services and internal boundaries remain explicit
...
### INV-PKG-OA-API-INTERNAL-HUBS-002: ModelUser and SessionUser remain separate
