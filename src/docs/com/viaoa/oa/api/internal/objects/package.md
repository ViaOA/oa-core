...
Defines internal object-service contracts used by OA runtime implementations.

## Architectural Role

Internal object operations API
...
OAObjectAnnotationOps, OAObjectAutoAddOps, OAObjectCSOps, OAObjectCacheOps, OAObjectChangeOps, OAObjectDSOps, OAObjectDeleteOps, OAObjectEnumOps, OAObjectEventOps, OAObjectFindOps, OAObjectGuidOps, OAObjectHubOps, OAObjectInfoOps, OAObjectInitializeOps, OAObjectKeyOps, OAObjectLockOps, OAObjectPropertyOps, OAObjectReflectOps
...
### INV-PKG-OA-API-INTERNAL-OBJECTS-001: Services and internal boundaries remain explicit
...
### INV-PKG-OA-API-INTERNAL-OBJECTS-002: ModelUser and SessionUser remain separate
