...
Defines stable Hub service surfaces for application-facing OA services.

## Architectural Role

Public Hub service API
...
HubAOOps, HubAutoMatchOps, HubCombineOps, HubCopyOps, HubDataOps, HubDetailOps, HubFilterOps, HubLinkOps, HubMergeOps, HubRootOps, HubShareOps, HubStatusOps, HubViewOps
...
### INV-PKG-OA-API-SERVICES-HUBS-001: Services and internal boundaries remain explicit
...
### INV-PKG-OA-API-SERVICES-HUBS-002: ModelUser and SessionUser remain separate
