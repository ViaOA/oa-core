...
Defines stable object service surfaces for application-facing OA services.

## Architectural Role

Public object service API
...
OAObjectCacheOps, OAObjectDeleteOps, OAObjectReflectOps
...
### INV-PKG-OA-API-SERVICES-OBJECTS-001: Services and internal boundaries remain explicit
...
### INV-PKG-OA-API-SERVICES-OBJECTS-002: ModelUser and SessionUser remain separate
