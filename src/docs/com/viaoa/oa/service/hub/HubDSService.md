# com.viaoa.oa.service.hub.HubDSService
...
HubDSService is a class in the hub runtime services area. Its invariants should be interpreted through the package role: Implements Hub behavior such as AO, add/remove, detail, sharing, select, sort, events, and relationship maintenance.
...
Public/protected methods reviewed: getDataSource, updateMany2ManyLinks, removeMany2ManyLinks, callObjectInfoIsMany2Many, callObjectInfoGetReverseLinkInfo, callHubAddRemoveGetRemovedObjects.

## Invariants

### INV-HUBDSSERVICE-001: Service delegates preserve runtime ownership

**Contract**

HubDSService must operate on OAObject/Hub state through the owning OA runtime and must not create unrelated global ownership.
...
src/main/java/com/viaoa/oa/service/hub/HubDSService.java, public/protected service methods
...
### INV-HUBDSSERVICE-002: Null and class context are explicit
...
getDataSource, updateMany2ManyLinks, removeMany2ManyLinks, callObjectInfoIsMany2Many, callObjectInfoGetReverseLinkInfo, callHubAddRemoveGetRemovedObjects
...
- Source file: `src/main/java/com/viaoa/oa/service/hub/HubDSService.java`
- Package: `com.viaoa.oa.service.hub`
- Type kind: `class`
- Methods/constructors referenced by invariant review: `getDataSource`, `updateMany2ManyLinks`, `removeMany2ManyLinks`, `callObjectInfoIsMany2Many`, `callObjectInfoGetReverseLinkInfo`, `callHubAddRemoveGetRemovedObjects`.
