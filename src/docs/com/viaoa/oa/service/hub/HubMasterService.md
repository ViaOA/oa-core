# com.viaoa.oa.service.hub.HubMasterService
...
HubMasterService is a class in the hub runtime services area. Its invariants should be interpreted through the package role: Implements Hub behavior such as AO, add/remove, detail, sharing, select, sort, events, and relationship maintenance.
...
Public/protected methods reviewed: getMasterObject, getMasterClass, getControllingHub, callHubDetailGetDataMaster, callHubLinkGetHubWithLink.

## Invariants

### INV-HUBMASTERSERVICE-001: Service delegates preserve runtime ownership

**Contract**

HubMasterService must operate on OAObject/Hub state through the owning OA runtime and must not create unrelated global ownership.
...
src/main/java/com/viaoa/oa/service/hub/HubMasterService.java, public/protected service methods
...
### INV-HUBMASTERSERVICE-002: Null and class context are explicit
...
getMasterObject, getMasterClass, getControllingHub, callHubDetailGetDataMaster, callHubLinkGetHubWithLink
...
- Source file: `src/main/java/com/viaoa/oa/service/hub/HubMasterService.java`
- Package: `com.viaoa.oa.service.hub`
- Type kind: `class`
- Methods/constructors referenced by invariant review: `getMasterObject`, `getMasterClass`, `getControllingHub`, `callHubDetailGetDataMaster`, `callHubLinkGetHubWithLink`.
