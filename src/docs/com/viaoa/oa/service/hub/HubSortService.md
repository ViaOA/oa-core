# com.viaoa.oa.service.hub.HubSortService
...
HubSortService is a class in the hub runtime services area. Its invariants should be interpreted through the package role: Implements Hub behavior such as AO, add/remove, detail, sharing, select, sort, events, and relationship maintenance.
...
Public/protected methods reviewed: sort, getSortListener, resort, cancelSort, keepSorted, isSorted, getSortProperty, getSortAsc, getSeqProperty, callHubCSSort, callHubSelectLoadAllData, callHubEventFireAfterSortEvent, callThreadLocalLock, callThreadLocalUnlock, callRemoteThreadStartNextThread, callThreadLocalAddSiblingHelper, callThreadLocalRemoveSiblingHelper.

Annotations present: SuppressWarnings.

## Invariants

### INV-HUBSORTSERVICE-001: Service delegates preserve runtime ownership

**Contract**

HubSortService must operate on OAObject/Hub state through the owning OA runtime and must not create unrelated global ownership.
...
src/main/java/com/viaoa/oa/service/hub/HubSortService.java, public/protected service methods
...
### INV-HUBSORTSERVICE-002: Null and class context are explicit
...
sort, getSortListener, resort, cancelSort, keepSorted, isSorted, getSortProperty, getSortAsc
...
- Source file: `src/main/java/com/viaoa/oa/service/hub/HubSortService.java`
- Package: `com.viaoa.oa.service.hub`
- Type kind: `class`
- Methods/constructors referenced by invariant review: `sort`, `getSortListener`, `resort`, `cancelSort`, `keepSorted`, `isSorted`, `getSortProperty`, `getSortAsc`, `getSeqProperty`, `callHubCSSort`, `callHubSelectLoadAllData`, `callHubEventFireAfterSortEvent`, `callThreadLocalLock`, `callThreadLocalUnlock`, `callRemoteThreadStartNextThread`, `callThreadLocalAddSiblingHelper`.
