# com.viaoa.oa.service.object.OAObjectEnumService
...
OAObjectEnumService is a class in the object runtime services area. Its invariants should be interpreted through the package role: Implements OAObject behavior such as metadata, identity, rules, persistence, property state, locking, and events.
...
Public/protected methods reviewed: getVEnums, callInfoGetObjectInfo.

## Invariants

### INV-OAOBJECTENUMSERVICE-001: Service delegates preserve runtime ownership

**Contract**

OAObjectEnumService must operate on OAObject/Hub state through the owning OA runtime and must not create unrelated global ownership.
...
src/main/java/com/viaoa/oa/service/object/OAObjectEnumService.java, public/protected service methods
...
### INV-OAOBJECTENUMSERVICE-002: Null and class context are explicit
...
getVEnums, callInfoGetObjectInfo
...
- Source file: `src/main/java/com/viaoa/oa/service/object/OAObjectEnumService.java`
- Package: `com.viaoa.oa.service.object`
- Type kind: `class`
- Methods/constructors referenced by invariant review: `getVEnums`, `callInfoGetObjectInfo`.
