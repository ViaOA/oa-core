# com.viaoa.oa.service.object.OAObjectGuidService
...
OAObjectGuidService is a class in the object runtime services area. Its invariants should be interpreted through the package role: Implements OAObject behavior such as metadata, identity, rules, persistence, property state, locking, and events.
...
Public/protected methods reviewed: assignGuid, assignNewGuid, getNextGuid_NOTUSED, getNextFiftyGuids_NOTUSED, getGuid, setGuid, setNextGuid_NOTUSEd, updateGuid_NOTUSED.

## Invariants

### INV-OAOBJECTGUIDSERVICE-001: Service delegates preserve runtime ownership

**Contract**

OAObjectGuidService must operate on OAObject/Hub state through the owning OA runtime and must not create unrelated global ownership.
...
src/main/java/com/viaoa/oa/service/object/OAObjectGuidService.java, public/protected service methods
...
### INV-OAOBJECTGUIDSERVICE-002: Null and class context are explicit
...
assignGuid, assignNewGuid, getNextGuid_NOTUSED, getNextFiftyGuids_NOTUSED, getGuid, setGuid, setNextGuid_NOTUSEd, updateGuid_NOTUSED
...
- Source file: `src/main/java/com/viaoa/oa/service/object/OAObjectGuidService.java`
- Package: `com.viaoa.oa.service.object`
- Type kind: `class`
- Methods/constructors referenced by invariant review: `assignGuid`, `assignNewGuid`, `getNextGuid_NOTUSED`, `getNextFiftyGuids_NOTUSED`, `getGuid`, `setGuid`, `setNextGuid_NOTUSEd`, `updateGuid_NOTUSED`.
