# com.viaoa.oa.service.object.OAObjectRecurseService
...
OAObjectRecurseService is a class in the object runtime services area. Its invariants should be interpreted through the package role: Implements OAObject behavior such as metadata, identity, rules, persistence, property state, locking, and events.
...
Public/protected methods reviewed: recurse, callObjectInfoGetOAObjectInfo, callObjectReflectGetProperty.

## Invariants

### INV-OAOBJECTRECURSESERVICE-001: Service delegates preserve runtime ownership

**Contract**

OAObjectRecurseService must operate on OAObject/Hub state through the owning OA runtime and must not create unrelated global ownership.
...
src/main/java/com/viaoa/oa/service/object/OAObjectRecurseService.java, public/protected service methods
...
### INV-OAOBJECTRECURSESERVICE-002: Null and class context are explicit
...
recurse, callObjectInfoGetOAObjectInfo, callObjectReflectGetProperty
...
- Source file: `src/main/java/com/viaoa/oa/service/object/OAObjectRecurseService.java`
- Package: `com.viaoa.oa.service.object`
- Type kind: `class`
- Methods/constructors referenced by invariant review: `recurse`, `callObjectInfoGetOAObjectInfo`, `callObjectReflectGetProperty`.
