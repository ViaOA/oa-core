# com.viaoa.oa.service.object.OAObjectStateService
...
OAObjectStateService is a class in the object runtime services area. Its invariants should be interpreted through the package role: Implements OAObject behavior such as metadata, identity, rules, persistence, property state, locking, and events.
...
Public/protected methods reviewed: setNew, callEventFireBeforePropertyChange, callEventFirePropertyChange, callAutoAddSetAutoAdd.

## Invariants

### INV-OAOBJECTSTATESERVICE-001: Service delegates preserve runtime ownership

**Contract**

OAObjectStateService must operate on OAObject/Hub state through the owning OA runtime and must not create unrelated global ownership.
...
src/main/java/com/viaoa/oa/service/object/OAObjectStateService.java, public/protected service methods
...
### INV-OAOBJECTSTATESERVICE-002: Null and class context are explicit
...
setNew, callEventFireBeforePropertyChange, callEventFirePropertyChange, callAutoAddSetAutoAdd
...
- Source file: `src/main/java/com/viaoa/oa/service/object/OAObjectStateService.java`
- Package: `com.viaoa.oa.service.object`
- Type kind: `class`
- Methods/constructors referenced by invariant review: `setNew`, `callEventFireBeforePropertyChange`, `callEventFirePropertyChange`, `callAutoAddSetAutoAdd`.
