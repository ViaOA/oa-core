# com.viaoa.oa.service.object.OAObjectUniqueService
...
OAObjectUniqueService is a class in the object runtime services area. Its invariants should be interpreted through the package role: Implements OAObject behavior such as metadata, identity, rules, persistence, property state, locking, and events.
...
Public/protected methods reviewed: getUnique, callCacheFind, callReflectCreateNewObject, callCSIsClient, callSyncClientGetUnique, callThreadLocalSetLoading.

## Invariants

### INV-OAOBJECTUNIQUESERVICE-001: Service delegates preserve runtime ownership

**Contract**

OAObjectUniqueService must operate on OAObject/Hub state through the owning OA runtime and must not create unrelated global ownership.
...
src/main/java/com/viaoa/oa/service/object/OAObjectUniqueService.java, public/protected service methods
...
### INV-OAOBJECTUNIQUESERVICE-002: Null and class context are explicit
...
getUnique, callCacheFind, callReflectCreateNewObject, callCSIsClient, callSyncClientGetUnique, callThreadLocalSetLoading
...
- Source file: `src/main/java/com/viaoa/oa/service/object/OAObjectUniqueService.java`
- Package: `com.viaoa.oa.service.object`
- Type kind: `class`
- Methods/constructors referenced by invariant review: `getUnique`, `callCacheFind`, `callReflectCreateNewObject`, `callCSIsClient`, `callSyncClientGetUnique`, `callThreadLocalSetLoading`.
