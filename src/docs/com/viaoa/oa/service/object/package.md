...
Implements OAObject behavior such as metadata, identity, rules, persistence, property state, locking, and events.
...
OALock, OAObjectAnnotationService, OAObjectAutoAddService, OAObjectCSService, OAObjectCacheService, OAObjectChangeService, OAObjectDSService, OAObjectDeleteService, OAObjectEmptyHubService, OAObjectEnumService, OAObjectEventService, OAObjectFindService, OAObjectGuidService, OAObjectHubService, OAObjectImportMatchService, OAObjectInfoService, OAObjectInitializeService, OAObjectKeyService
...
### INV-PKG-OA-SERVICE-OBJECT-001: Services and internal boundaries remain explicit
...
### INV-PKG-OA-SERVICE-OBJECT-002: ModelUser and SessionUser remain separate
