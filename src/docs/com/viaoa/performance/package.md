...
Provides OA runtime support types for the com.viaoa.performance package.
...
### INV-PKG-PERFORMANCE-001: Public contracts remain deterministic
...
### INV-PKG-PERFORMANCE-002: Shared mutable state is explicit
