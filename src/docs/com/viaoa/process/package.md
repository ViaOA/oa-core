...
Defines change processors, refreshers, cron, and thread monitoring utilities.
...
OAChangeProcessor, OAChangeRefresher, OACron, OACronProcessor, OAProcess, OAThreadMonitor
...
### INV-PKG-PROCESS-001: Public contracts remain deterministic
...
Package classes: OAChangeProcessor, OAChangeRefresher, OACron, OACronProcessor, OAProcess, OAThreadMonitor
...
### INV-PKG-PROCESS-002: Shared mutable state is explicit
