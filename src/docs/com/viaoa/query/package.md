...
Defines query tokens, tokenizer, and query representation for datasource/filter use.
...
OAQuery, OAQueryToken, OAQueryTokenManager, OAQueryTokenType, OAQueryTokenizer

## Package-Level Invariants

### INV-PKG-QUERY-001: Public contracts remain deterministic
...
Package classes: OAQuery, OAQueryToken, OAQueryTokenManager, OAQueryTokenType, OAQueryTokenizer
...
### INV-PKG-QUERY-002: Shared mutable state is explicit
