...
Provides OA runtime support types for the com.viaoa.queue package.
...
### INV-PKG-QUEUE-001: Public contracts remain deterministic
...
Package classes: OACircularQueue
...
### INV-PKG-QUEUE-002: Shared mutable state is explicit
