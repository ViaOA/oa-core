...
Provides OA runtime support types for the com.viaoa.reflect package.
...
### INV-PKG-REFLECT-001: Public contracts remain deterministic
...
### INV-PKG-REFLECT-002: Shared mutable state is explicit
