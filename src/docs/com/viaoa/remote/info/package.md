...
BindInfo, MethodInfo, RequestInfo
...
### INV-PKG-REMOTE-INFO-001: Remote identities and method contracts are serializable
...
### INV-PKG-REMOTE-INFO-002: Client/server state changes are ordered
