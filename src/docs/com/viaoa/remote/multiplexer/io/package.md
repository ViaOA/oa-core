...
RemoteBufferedOutputStream, RemoteObjectInputStream, RemoteObjectOutputStream
...
### INV-PKG-REMOTE-MULTIPLEXER-IO-001: Remote identities and method contracts are serializable
...
### INV-PKG-REMOTE-MULTIPLEXER-IO-002: Client/server state changes are ordered
