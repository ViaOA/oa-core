...
OARemoteMultiplexerClient, OARemoteMultiplexerServer
...
### INV-PKG-REMOTE-MULTIPLEXER-001: Remote identities and method contracts are serializable
...
### INV-PKG-REMOTE-MULTIPLEXER-002: Client/server state changes are ordered
