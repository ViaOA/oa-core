...
### INV-PKG-REPLICATION-CLIENT-001: Remote identities and method contracts are serializable
...
### INV-PKG-REPLICATION-CLIENT-002: Client/server state changes are ordered
