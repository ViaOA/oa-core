...
OAReplTLog, OAReplicationBase, OAReplicationClient, OAReplicationMaster
...
### INV-PKG-REPLICATION-001: Remote identities and method contracts are serializable
...
### INV-PKG-REPLICATION-002: Client/server state changes are ordered
