...
Coordinates transaction-log and master/client replication behavior.
...
RemoteClientInterface, RemoteMasterInterface, RemoteMasterRegisterInterface
...
### INV-PKG-REPLICATION-REMOTE-001: Remote identities and method contracts are serializable
...
### INV-PKG-REPLICATION-REMOTE-002: Client/server state changes are ordered
