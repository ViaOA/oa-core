...
Locates OA runtimes and owns thread-local, remote-thread, datasource, and thread execution services.

## Architectural Role

Runtime registry and thread services
...
OADataSourceService, OARemoteThreadService, OARuntime, OAThreadLocalService, OAThreadService
...
### INV-PKG-RUNTIME-001: Public contracts remain deterministic
...
Package classes: OADataSourceService, OARemoteThreadService, OARuntime, OAThreadLocalService, OAThreadService
...
### INV-PKG-RUNTIME-002: Shared mutable state is explicit
