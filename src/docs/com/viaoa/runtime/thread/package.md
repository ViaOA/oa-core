...
OARemoteThread, OAThread, OAThreadLocal, OAThreadLocalHubMergerCallback
...
### INV-PKG-RUNTIME-THREAD-001: Public contracts remain deterministic
...
Package classes: OARemoteThread, OAThread, OAThreadLocal, OAThreadLocalHubMergerCallback
...
### INV-PKG-RUNTIME-THREAD-002: Shared mutable state is explicit
