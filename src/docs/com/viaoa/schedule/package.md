...
Provides OA runtime support types for the com.viaoa.schedule package.
...
OADateChangeController, OADateTimeRange, OASchedule, OAScheduler, OASchedulerController, OASchedulerPlan
...
### INV-PKG-SCHEDULE-001: Public contracts remain deterministic
...
Package classes: OADateChangeController, OADateTimeRange, OASchedule, OAScheduler, OASchedulerController, OASchedulerPlan
...
### INV-PKG-SCHEDULE-002: Shared mutable state is explicit
