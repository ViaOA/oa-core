...
Provides OA runtime support types for the com.viaoa.secure package.
...
### INV-PKG-SECURE-001: Public contracts remain deterministic
...
Package classes: Base64, OAEncryption
...
### INV-PKG-SECURE-002: Shared mutable state is explicit
