...
Coordinates OASelect lifecycle and datasource-backed object loading.
...
### INV-PKG-SELECT-001: Datasource operations are model-class scoped
...
### INV-PKG-SELECT-002: Iterators must release datasource resources
