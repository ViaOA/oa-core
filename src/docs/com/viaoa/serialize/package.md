...
Defines OA serialization contexts, readers, writers, serializers, and deserializers.
...
OADeserializer, OAObjectSerializer, OASerializeContext, OASerializeReader, OASerializeWriter, OASerializer
...
### INV-PKG-SERIALIZE-001: Public contracts remain deterministic
...
Package classes: OADeserializer, OAObjectSerializer, OASerializeContext, OASerializeReader, OASerializeWriter, OASerializer
...
### INV-PKG-SERIALIZE-002: Shared mutable state is explicit
