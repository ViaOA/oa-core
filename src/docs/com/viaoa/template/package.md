...
Provides OA runtime support types for the com.viaoa.template package.
...
### INV-PKG-TEMPLATE-001: Public contracts remain deterministic
...
Package classes: OAMatrix, OATemplate
...
### INV-PKG-TEMPLATE-002: Shared mutable state is explicit
