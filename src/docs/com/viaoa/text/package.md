...
Defines text formatting, escaping, comparison, generation, tokenizing, and sanitizing utilities.
...
IndentFormatter, OARegex, OATextAlign, OATextChars, OATextCode, OATextCompare, OATextEscape, OATextFilter, OATextFormat, OATextGenerate, OATextGrammar, OATextLineWrap, OATextSanitize, OATextSoundex, OATextTokenizer, OATextUtil
...
### INV-PKG-TEXT-001: Public contracts remain deterministic
...
Package classes: IndentFormatter, OARegex, OATextAlign, OATextChars, OATextCode, OATextCompare, OATextEscape, OATextFilter, OATextFormat, OATextGenerate
...
### INV-PKG-TEXT-002: Shared mutable state is explicit
