...
Defines transaction lifecycle and listener contracts.
...
OATransaction, OATransactionListener
...
### INV-PKG-TRANSACTION-001: Public contracts remain deterministic
...
Package classes: OATransaction, OATransactionListener
...
### INV-PKG-TRANSACTION-002: Shared mutable state is explicit
