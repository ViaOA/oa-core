...
Defines trigger listeners and trigger metadata for dependent changes.
...
OATrigger, OATriggerListener, OATriggerMethodListener
...
### INV-PKG-TRIGGER-001: Public contracts remain deterministic
...
Package classes: OATrigger, OATriggerListener, OATriggerMethodListener
...
### INV-PKG-TRIGGER-002: Shared mutable state is explicit
