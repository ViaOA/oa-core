...
Provides OA runtime support types for the com.viaoa.undo package.
...
### INV-PKG-UNDO-001: Public contracts remain deterministic
...
Package classes: OAUndoManager, OAUndoableEdit
...
### INV-PKG-UNDO-002: Shared mutable state is explicit
