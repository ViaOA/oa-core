...
public class Table {
	...
	/**
	 * columns that are needed to retrieve when selecting; these include all columns that are mapped to a property and all columns that are
	 * needed as fkeys to other objects
	 */
