...
import com.viaoa.object.OAObjectJsonDelegate;
...
public class OAJsonWriter {
	 ...
	 * to control which properties are saved. default is true;
	 */
	...
	/**
	 * Current propertyPath from the root OAObject. Only includes reference/link names, no regular properties
	 */
