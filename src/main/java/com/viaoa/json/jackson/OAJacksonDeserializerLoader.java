...
public class OAJacksonDeserializerLoader {
	...
	//qqqqqqqqqqqqqqqqqvvvvvvvvvvvv need to be able to create Root nodes ...
	//qqqqqqqqqq ex: reporterCorp.ripi when just loading rip
