 ...
 * OA runtime to integrate behavior directly into the OA model without
...
public class OAMethodInfo implements java.io.Serializable {
    ...
    /**
     * Returns the ModelUser property path used to determine method visibility.
     *
     * @return ModelUser visible property path, or {@code null}
     */
