...
Contract statement: Parent services in com.viaoa.graph.service are owned by a single OA and coordinate object,
...
Source scope: OATriggerService, TriggerOps integration, OA trigger facade integration.
