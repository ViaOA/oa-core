...
public class OAObjectInfoDelegate {
    ...
    */
	 ...
	 */
	public static void addCalcInfo(OAObjectInfo thisOI, OACalcInfo ci) {
		Class c = thisOI.getForClass();
		if (c == null) return;
		OAGraph g = OARuntime.get().graph(c);
		if (g == null) return;
	 ...
	 */
	public static void storeMethod(Class clazz, Method method) {
		OAGraph g = OARuntime.get().graph(clazz);
		if (g == null) return;
	 ...
	 */
	public static Map<String, Method> getClassMethodMap(Class clazz) {
		OAGraph g = OARuntime.get().graph(clazz);
		if (g == null) return null;
	 ...
	 */
    public static Set<String> getClassMethodNotFoundMap(Class clazz) {
		OAGraph g = OARuntime.get().graph(clazz);
		if (g == null) return null;
