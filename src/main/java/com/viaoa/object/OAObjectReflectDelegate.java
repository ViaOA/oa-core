...
public class OAObjectReflectDelegate {
	...
	public static Logger LOG = Logger.getLogger(OAObjectReflectDelegate.class.getName());
    ...
    */
	 ...
	 */
	public static Hub findCommonHierarchyHub(OAObject obj1, OAObject obj2, int currentLevel, int maxLevelsToCheck) {
		OAGraph g = getGraph(null, obj1);
		if (g == null) return null;
	 ...
	 * @return the number of levels to reach the Hub, or -1 if not found
	 */
	public static int getHierarchyLevelsToHub(Hub findHub, OAObject fromObj, int currentLevel, int maxLevelsToCheck) {
		OAGraph g = getGraph(null, fromObj);
		if (g == null) return -1;
