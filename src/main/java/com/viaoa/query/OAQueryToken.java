...
CODEX
 ...
 #4 — FIX NOW
  Location: src/main/java/com/viaoa/datasource/query/OAQueryToken.java:65
  NOTLIKE is not treated as an operator by isOperator(). That can break parser/comparison flow because evaluateB()
  only consumes token.isOperator().
