...
public class OARemoteThread extends Thread {
	...
	/**
	 * Flag to know if the addRunnable was overwritten to handle in another thread (pool). Otherwise, calling addRunnable will call the
	 * run() method directly.
	 */
	...
	/**
	 * By default, this will call r.run(). This can be overwritten to have it ran in another way.
	 */
