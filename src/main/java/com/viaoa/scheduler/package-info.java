 ...
 * <ul>
 *   <li>{@link com.viaoa.scheduler.OADateTimeRange} – representation of an
 *       individual date–time range.</li>
 *   <li>{@link com.viaoa.scheduler.OASchedule} – interval-set structure for
 *       merging and iterating date–time ranges.</li>
 *   <li>{@link com.viaoa.scheduler.OASchedulerPlan} – full plan containing
 *       open, preferred, blocked, and scheduled ranges.</li>
 *   <li>{@link com.viaoa.scheduler.OAScheduler} – aggregator for multiple
 *       plans belonging to a resource or object.</li>
 *   <li>{@link com.viaoa.scheduler.OASchedulerController} – controller for
