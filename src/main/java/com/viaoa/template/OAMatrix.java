...
public class OAMatrix {
     ...
     */
    public Column addDetailColumn(OAMatrix.Column colFrom, String pp) {
     ...
     * @throws RuntimeException if the property path is not a valid link
     */
    public Column addGroupByColumn(OAMatrix.Column colLeft, Hub hub, String pp, String matchPropName) {
    ...
    /*qqqqqqqqq
    public Column addGroupByColumn(OAMatrix.Column colLeft, OAObject obj, String pp, String matchPropName) {
        if (colLeft == null) return null;
