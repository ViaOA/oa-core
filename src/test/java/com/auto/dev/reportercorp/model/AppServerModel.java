...
import com.auto.dev.reportercorp.model.search.AppUserLoginSearchModel;
...
public class AppServerModel extends OAObjectModel {
	...
	public AppServerModel(Hub<AppServer> hubAppServer) {
		...
		if (hubAppServer != null) {
			HubDelegate.setObjectClass(hubAppServer, AppServer.class);
		}
	...
	public AppUserLoginSearchModel getAppUserLoginSearchModel() {
		if (modelAppUserLoginSearch != null) {
