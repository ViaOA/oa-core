...
public class ContactModel extends OAObjectModel {
    ...
    protected PhoneSearchModel modelPhonesSearch;
    ...
    public OrderContactModel getOrderContactsModel() {
        ...
        // call Contact.orderContactsModelCallback(OrderContactModel) to be able to customize this model
    ...
    public PhoneModel getPhonesModel() {
        ...
        if (HubDetailDelegate.getIsFromSameMasterHub(getOriginalHub(), getPhones())) {
        ...
        modelPhones.setAllowRefresh(false);
        modelPhones.setAllowSearch(false);
        modelPhones.setAllowHubSearch(true);
        modelPhones.setAllowDownload(true);
        ...
        // call Contact.phonesModelCallback(PhoneModel) to be able to customize this model
    ...
    public CustomerSearchModel getCustomerSearchModel() {
        ...
        HubSelectDelegate.adoptWhereHub(modelCustomerSearch.getHub(), Contact.P_Customer, getHub());
    ...
    public PhoneSearchModel getPhonesSearchModel() {
        if (modelPhonesSearch != null) return modelPhonesSearch;
        modelPhonesSearch = new PhoneSearchModel();
        return modelPhonesSearch;
    }
