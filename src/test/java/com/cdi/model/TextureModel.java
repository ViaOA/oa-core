...
public class TextureModel extends OAObjectModel {
    ...
    public Hub<Order> getOrders() {
        ...
        hubOrders.setSelectWhereHub(getHub(), Texture.P_Orders);
    ...
    public OrderModel getOrdersModel() {
        ...
        // call Texture.ordersModelCallback(OrderModel) to be able to customize this model
        OAObjectCallbackDelegate.onObjectCallbackModel(Texture.class, Texture.P_Orders, modelOrders);
