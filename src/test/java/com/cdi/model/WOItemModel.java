...
public class WOItemModel extends OAObjectModel {
    ...
    protected OrderItemSearchModel modelOrderItemSearch;
    ...
    public OrderItemModel getOrderItemModel() {
        ...
        // call WOItem.orderItemModelCallback(OrderItemModel) to be able to customize this model
    ...
    public OrderItemSearchModel getOrderItemSearchModel() {
        if (modelOrderItemSearch != null) return modelOrderItemSearch;
        modelOrderItemSearch = new OrderItemSearchModel();
        HubSelectDelegate.adoptWhereHub(modelOrderItemSearch.getHub(), WOItem.P_OrderItem, getHub());
        return modelOrderItemSearch;
    }
    public WorkOrderSearchModel getWorkOrderSearchModel() {
        ...
        HubSelectDelegate.adoptWhereHub(modelWorkOrderSearch.getHub(), WOItem.P_WorkOrder, getHub());
