...
public class WebItemModel extends OAObjectModel {
    ...
    protected WebPartSearchModel modelWebPartSearch;
    ...
    public ItemModel getItemModel() {
        ...
        // call WebItem.itemModelCallback(ItemModel) to be able to customize this model
    ...
    public ItemSearchModel getItemSearchModel() {
        ...
        HubSelectDelegate.adoptWhereHub(modelItemSearch.getHub(), WebItem.P_Item, getHub());
        return modelItemSearch;
    }
    public WebPartSearchModel getWebPartSearchModel() {
        if (modelWebPartSearch != null) return modelWebPartSearch;
        modelWebPartSearch = new WebPartSearchModel();
        HubSelectDelegate.adoptWhereHub(modelWebPartSearch.getHub(), WebItem.P_WebPart, getHub());
        return modelWebPartSearch;
    }
