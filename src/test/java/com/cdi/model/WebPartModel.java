...
import com.viaoa.hub.detail.HubRoot;
...
public class WebPartModel extends OAObjectModel {
    ...
    */
    ...
    protected Hub<WebPage> hubLinkToWebPageSelectFrom;
    protected Hub<WebPage> hubWebPageSelectFrom;
    
    // pickFrom
    protected Hub<Item> hubWebItemsPickFromItem;
    ...
    // selectFrom
    protected WebPageModel modelLinkToWebPageSelectFrom;
    protected WebPageModel modelWebPageSelectFrom;
    
    // pickFrom
    protected ItemModel modelWebItemsPickFromItem;
    protected ItemSearchModel modelWebItemsPickFromItemSearch;
    
    // SearchModels used for references
    protected ImageStoreSearchModel modelImageStoreSearch;
    protected WebPageSearchModel modelLinkToWebPageSearch;
    protected WebPartSearchModel modelParentWebPartSearch;
    protected WebPageSearchModel modelWebPageSearch;
    ...
    public Hub<WebPage> getLinkToWebPageHub() {
        ...
        hubLinkToWebPage = getHub().getDetailHub(WebPart.P_LinkToWebPage);
    ...
    public Hub<WebPage> getLinkToWebPageSelectFromHub() {
        if (hubLinkToWebPageSelectFrom != null) return hubLinkToWebPageSelectFrom;
        hubLinkToWebPageSelectFrom = new Hub<WebPage>(WebPage.class);
        Hub<WebPage> hubLinkToWebPageSelectFrom1 = ModelDelegate.getWebPages().createSharedHub();
        HubCombined<WebPage> hubCombined = new HubCombined(hubLinkToWebPageSelectFrom, hubLinkToWebPageSelectFrom1, getLinkToWebPageHub());
        hubLinkToWebPageSelectFrom.setLinkHub(getHub(), WebPart.P_LinkToWebPage); 
        return hubLinkToWebPageSelectFrom;
    }
    public Hub<WebPage> getWebPageSelectFromHub() {
        if (hubWebPageSelectFrom != null) return hubWebPageSelectFrom;
        hubWebPageSelectFrom = new Hub<WebPage>(WebPage.class);
        Hub<WebPage> hubWebPageSelectFrom1 = ModelDelegate.getWebPages().createSharedHub();
        HubCombined<WebPage> hubCombined = new HubCombined(hubWebPageSelectFrom, hubWebPageSelectFrom1, getWebPageHub());
        hubWebPageSelectFrom.setLinkHub(getHub(), WebPart.P_WebPage); 
        return hubWebPageSelectFrom;
    }
    public Hub<Item> getWebItemsPickFromItemHub() {
        if (hubWebItemsPickFromItem != null) return hubWebItemsPickFromItem;
        hubWebItemsPickFromItem = new Hub<Item>(Item.class);
        return hubWebItemsPickFromItem;
    }
    ...
    public ImageStoreModel getImageStoreModel() {
        ...
        // call WebPart.imageStoreModelCallback(ImageStoreModel) to be able to customize this model
    ...
    public WebPageModel getLinkToWebPageModel() {
        ...
        // call WebPart.linkToWebPageModelCallback(WebPageModel) to be able to customize this model
    ...
    public WebPartModel getParentWebPartModel() {
        ...
        // call WebPart.parentWebPartModelCallback(WebPartModel) to be able to customize this model
    ...
    public WebItemModel getWebItemsModel() {
        ...
        // call WebPart.webItemsModelCallback(WebItemModel) to be able to customize this model
    ...
    public WebPartModel getWebPartsModel() {
        ...
        modelWebParts.setPluralDisplayName("Sub Web Parts");
        ...
        // call WebPart.webPartsModelCallback(WebPartModel) to be able to customize this model
        OAObjectCallbackDelegate.onObjectCallbackModel(WebPart.class, WebPart.P_WebParts, modelWebParts);
    
        return modelWebParts;
    }
    
    public WebPageModel getLinkToWebPageSelectFromModel() {
        if (modelLinkToWebPageSelectFrom != null) return modelLinkToWebPageSelectFrom;
        modelLinkToWebPageSelectFrom = new WebPageModel(getLinkToWebPageSelectFromHub());
        modelLinkToWebPageSelectFrom.setDisplayName("Web Page");
        modelLinkToWebPageSelectFrom.setPluralDisplayName("Web Pages");
        modelLinkToWebPageSelectFrom.setForJfc(getForJfc());
        modelLinkToWebPageSelectFrom.setAllowNew(false);
        modelLinkToWebPageSelectFrom.setAllowSave(true);
        modelLinkToWebPageSelectFrom.setAllowAdd(false);
        modelLinkToWebPageSelectFrom.setAllowMove(false);
        modelLinkToWebPageSelectFrom.setAllowRemove(false);
        modelLinkToWebPageSelectFrom.setAllowDelete(false);
        modelLinkToWebPageSelectFrom.setAllowSearch(false);
        modelLinkToWebPageSelectFrom.setAllowHubSearch(true);
        modelLinkToWebPageSelectFrom.setAllowGotoEdit(true);
        modelLinkToWebPageSelectFrom.setViewOnly(getViewOnly());
        modelLinkToWebPageSelectFrom.setAllowNew(false);
        modelLinkToWebPageSelectFrom.setAllowTableFilter(true);
        modelLinkToWebPageSelectFrom.setAllowTableSorting(true);
        modelLinkToWebPageSelectFrom.setAllowCut(false);
        modelLinkToWebPageSelectFrom.setAllowCopy(false);
        modelLinkToWebPageSelectFrom.setAllowPaste(false);
        modelLinkToWebPageSelectFrom.setAllowMultiSelect(false);
        return modelLinkToWebPageSelectFrom;
    }
    public WebPageModel getWebPageSelectFromModel() {
        if (modelWebPageSelectFrom != null) return modelWebPageSelectFrom;
        modelWebPageSelectFrom = new WebPageModel(getWebPageSelectFromHub());
        modelWebPageSelectFrom.setDisplayName("Web Page");
        modelWebPageSelectFrom.setPluralDisplayName("Web Pages");
        modelWebPageSelectFrom.setForJfc(getForJfc());
        modelWebPageSelectFrom.setAllowNew(false);
        modelWebPageSelectFrom.setAllowSave(true);
        modelWebPageSelectFrom.setAllowAdd(false);
        modelWebPageSelectFrom.setAllowMove(false);
        modelWebPageSelectFrom.setAllowRemove(false);
        modelWebPageSelectFrom.setAllowDelete(false);
        modelWebPageSelectFrom.setAllowSearch(false);
        modelWebPageSelectFrom.setAllowHubSearch(true);
        modelWebPageSelectFrom.setAllowGotoEdit(true);
        modelWebPageSelectFrom.setViewOnly(getViewOnly());
        modelWebPageSelectFrom.setAllowNew(false);
        modelWebPageSelectFrom.setAllowTableFilter(true);
        modelWebPageSelectFrom.setAllowTableSorting(true);
        modelWebPageSelectFrom.setAllowCut(false);
        modelWebPageSelectFrom.setAllowCopy(false);
        modelWebPageSelectFrom.setAllowPaste(false);
        modelWebPageSelectFrom.setAllowMultiSelect(false);
        return modelWebPageSelectFrom;
    }
    public ItemModel getWebItemsPickFromItemModel() {
        if (modelWebItemsPickFromItem != null) return modelWebItemsPickFromItem;
        modelWebItemsPickFromItem = new ItemModel(getWebItemsPickFromItemHub());
        modelWebItemsPickFromItem.setDisplayName("Web Item");
        modelWebItemsPickFromItem.setPluralDisplayName("Web Items");
        modelWebItemsPickFromItem.setForJfc(getForJfc());
        modelWebItemsPickFromItem.setAllowNew(false);
        modelWebItemsPickFromItem.setAllowSave(true);
        modelWebItemsPickFromItem.setAllowAdd(false);
        modelWebItemsPickFromItem.setAllowMove(false);
        modelWebItemsPickFromItem.setAllowRemove(false);
        modelWebItemsPickFromItem.setAllowDelete(false);
        modelWebItemsPickFromItem.setAllowRefresh(false);
        modelWebItemsPickFromItem.setAllowSearch(true);
        modelWebItemsPickFromItem.setAllowHubSearch(true);
        modelWebItemsPickFromItem.setAllowGotoEdit(true);
        modelWebItemsPickFromItem.setViewOnly(getViewOnly());
        modelWebItemsPickFromItem.setAllowNew(false);
        modelWebItemsPickFromItem.setAllowTableFilter(true);
        modelWebItemsPickFromItem.setAllowTableSorting(true);
        modelWebItemsPickFromItem.setAllowCut(false);
        modelWebItemsPickFromItem.setAllowCopy(false);
        modelWebItemsPickFromItem.setAllowPaste(false);
        new HubMerger<WebItem, Item>(getWebItems(), modelWebItemsPickFromItem.getMultiSelectHub(), WebItem.P_Item);
        return modelWebItemsPickFromItem;
    }
    public ItemSearchModel getWebItemsPickFromItemSearchModel() {
        if (modelWebItemsPickFromItemSearch != null) return modelWebItemsPickFromItemSearch;
        return modelWebItemsPickFromItemSearch;
    }
    public ImageStoreSearchModel getImageStoreSearchModel() {
        ...
        HubSelectDelegate.adoptWhereHub(modelImageStoreSearch.getHub(), WebPart.P_ImageStore, getHub());
        return modelImageStoreSearch;
    }
    public WebPageSearchModel getLinkToWebPageSearchModel() {
        if (modelLinkToWebPageSearch != null) return modelLinkToWebPageSearch;
        modelLinkToWebPageSearch = new WebPageSearchModel();
        HubSelectDelegate.adoptWhereHub(modelLinkToWebPageSearch.getHub(), WebPart.P_LinkToWebPage, getHub());
        return modelLinkToWebPageSearch;
    }
    public WebPartSearchModel getParentWebPartSearchModel() {
        if (modelParentWebPartSearch != null) return modelParentWebPartSearch;
        modelParentWebPartSearch = new WebPartSearchModel();
        HubSelectDelegate.adoptWhereHub(modelParentWebPartSearch.getHub(), WebPart.P_ParentWebPart, getHub());
        return modelParentWebPartSearch;
    }
    public WebPageSearchModel getWebPageSearchModel() {
        if (modelWebPageSearch != null) return modelWebPageSearch;
        modelWebPageSearch = new WebPageSearchModel();
        HubSelectDelegate.adoptWhereHub(modelWebPageSearch.getHub(), WebPart.P_WebPage, getHub());
        return modelWebPageSearch;
    }
