...
public class WorkOrderModel extends OAObjectModel {
    ...
    */
    ...
    public UserModel getAssignedUsersModel() {
        ...
        if (HubDetailDelegate.getLinkInfoFromMasterToDetail(getOriginalHub().getMasterHub()) == HubDetailDelegate.getLinkInfoFromMasterToDetail(getAssignedUsers())) {
    ...
    public WorkOrderPalletModel getWorkOrderPalletsModel() {
        ...
        if (HubDetailDelegate.getLinkInfoFromMasterToDetail(getOriginalHub().getMasterHub()) == HubDetailDelegate.getLinkInfoFromMasterToDetail(getWorkOrderPallets())) {
