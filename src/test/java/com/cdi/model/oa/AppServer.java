...
/**
  Information about the server instance.<br>Created by ServerController 
    during startup, along with the reference to AppUserLogin
*/
@OAClass(
    lowerName = "appServer",
    ...
    description = "Information about the server instance.<br>Created by ServerController      during startup, along with the reference to AppUserLogin",
    isProcessed = true,
...
public class AppServer extends OAObject {
    ...
    @OAProperty(lowerName = "demoMode", displayName = "Demo Mode", displayLength = 5, uiColumnLength = 9, isProcessed = true)
    ...
    @OAProperty(lowerName = "release", maxLength = 18, displayLength = 8, uiColumnLength = 7, isProcessed = true)
