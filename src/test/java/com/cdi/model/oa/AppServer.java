...
public class AppServer extends OAObject {
    ...
    @OAProperty(displayName = "Demo Mode", displayLength = 5, columnLength = 9, isProcessed = true)
    ...
    @OAProperty(maxLength = 18, displayLength = 8, columnLength = 7, isProcessed = true)
