...
@OAClass(shortName = "au", displayName = "App User", isLookup = true, isPreSelect = true, displayProperty = "displayName", estimatedTotal = 20)
@OATable()
public class AppUser extends OAObject {
	...
	@OAProperty(displayName = "Login Id", maxLength = 24, displayLength = 10)
	...
	@OAProperty(maxLength = 50, displayLength = 10, isPassword = true)
	...
	@OAProperty(displayName = "First Name", maxLength = 30, displayLength = 20, columnLength = 12)
	...
	@OAProperty(displayName = "Last Name", maxLength = 55, displayLength = 20, columnLength = 12)
	...
	@OAProperty(displayName = "Edit Processed", displayLength = 5, columnLength = 14)
	@OAColumn(sqlType = java.sql.Types.BOOLEAN)
	...
	@OAProperty(maxLength = 40, displayLength = 20)
	...
	@OAOne(reverseName = User.P_AppUser, isProcessed = true, allowCreateNew = false, allowAddExisting = false)
	public User getUser() {
		if (user == null) {
	...
	public void load(ResultSet rs, int id) throws SQLException {
		...
		this.editProcessed = (rs.getShort(8) == 1);
		if (rs.wasNull()) {
