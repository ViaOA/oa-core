...
public class AppUserError extends OAObject {
    ...
    @OAProperty(lowerName = "dateTime", displayName = "Date Time", displayLength = 15, isProcessed = true, ignoreTimeZone = true)
    ...
    @OAProperty(lowerName = "message", maxLength = 250, displayLength = 20)
    ...
    @OAProperty(lowerName = "stackTrace", displayName = "Stack Trace", displayLength = 20)
    ...
    @OAProperty(lowerName = "reviewed", displayLength = 8)
    ...
    @OAProperty(lowerName = "reviewNote", displayName = "Review Note", maxLength = 254, displayLength = 20)
