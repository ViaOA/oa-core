...
public class AppUserLogin extends OAObject {
    ...
    @OAProperty(lowerName = "location", maxLength = 50, displayLength = 20, uiColumnLength = 15, isProcessed = true)
    ...
    @OAProperty(lowerName = "computerName", displayName = "Computer Name", maxLength = 32, displayLength = 20, uiColumnLength = 15, isProcessed = true)
    ...
    @OAProperty(lowerName = "disconnected", displayLength = 15, isProcessed = true, ignoreTimeZone = true)
    ...
    @OAProperty(lowerName = "connectionId", displayName = "Connection Id", displayLength = 6, uiColumnLength = 13, isProcessed = true)
    ...
    @OAProperty(lowerName = "hostName", displayName = "Host Name", maxLength = 35, displayLength = 20, uiColumnLength = 15, isProcessed = true)
    ...
    @OAProperty(lowerName = "ipAddress", displayName = "Ip Address", maxLength = 20, displayLength = 20, uiColumnLength = 15, isProcessed = true)
    ...
    @OAProperty(lowerName = "totalMemory", displayName = "Total Memory", displayLength = 6, uiColumnLength = 7, uiColumnName = "Tot Mem", isProcessed = true)
    ...
    @OAProperty(lowerName = "freeMemory", displayName = "Free Memory", displayLength = 6, uiColumnLength = 8, uiColumnName = "Free Mem", isProcessed = true)
