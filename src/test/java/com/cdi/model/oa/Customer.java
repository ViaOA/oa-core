...
import com.cdi.model.oa.filter.CustomerActiveFilter;
...
@OAClass(shortName = "cus", displayName = "Customer", isProcessed = true, displayProperty = "name", sortProperty = "name", estimatedTotal = 15000, filterClasses = {
		CustomerActiveFilter.class })
@OATable(indexes = {
...
public class Customer extends OAObject {
	...
	public void currentBalanceCallback(OAObjectCallback em) {
	}
	...
	@OAObjCallback(contextVisibleProperty = AppUser.P_User + "." + User.P_CalcPricingReadAccess)
	public void mtdCostsCallback(OAObjectCallback em) {
	}
	...
	@OAObjCallback(contextVisibleProperty = AppUser.P_User + "." + User.P_CalcPricingReadAccess)
	public void ytdCostsCallback(OAObjectCallback em) {
	}
	...
	@OAObjCallback(contextVisibleProperty = AppUser.P_User + "." + User.P_CalcPricingReadAccess)
	public void priorYearCostCallback(OAObjectCallback em) {
	}
	...
	@OAMany(toClass = Contact.class, owner = true, reverseName = Contact.P_Customer, cascadeSave = true, cascadeDelete = true)
	...
	@OAMany(toClass = Order.class, cacheSize = 50, reverseName = Order.P_Customer, isProcessed = true)
	...
	@OAOne(reverseName = Region.P_Customers, allowCreateNew = false)
	...
	@OAMany(displayName = "Sales Customers", toClass = SalesCustomer.class, reverseName = SalesCustomer.P_Customer, createMethod = false)
	private Hub<SalesCustomer> getSalesCustomers() {
		// oamodel has createMethod set to false, this method exists only for annotations.
		return null;
	}

	@OAOne(displayName = "Tax Code", reverseName = TaxCode.P_Customers, allowCreateNew = false)
