...
import com.cdi.model.oa.filter.ItemAddOnActiveFilter;
...
@OAClass(shortName = "iao", displayName = "Item Add On", isLookup = true, isPreSelect = true, displayProperty = "code", sortProperty = "code", filterClasses = {
		ItemAddOnActiveFilter.class })
@OATable()
public class ItemAddOn extends OAObject {
	...
	@OAObjCallback(contextEnabledProperty = AppUser.P_User + "." + User.P_CalcPricingWriteAccess, contextVisibleProperty = AppUser.P_User
			+ "." + User.P_CalcPricingReadAccess)
	public void priceCallback(OAObjectCallback em) {
	}
	...
	@OAMany(displayName = "Item Quotes", toClass = ItemQuote.class, reverseName = ItemQuote.P_ItemAddOn, createMethod = false)
	private Hub<ItemQuote> getItemQuotes() {
		// oamodel has createMethod set to false, this method exists only for annotations.
		return null;
	}

	@OAMany(displayName = "Sales Order Items", toClass = SalesOrderItem.class, reverseName = SalesOrderItem.P_ItemAddOns, createMethod = false)
	...
	public void load(ResultSet rs, int id) throws SQLException {
		...
		date = rs.getDate(6);
		if (date != null) {
			this.discontinuedDate = new OADate(date);
		}
