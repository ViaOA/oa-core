...
@OAClass(shortName = "orc", displayName = "Order Contact", displayProperty = "contact", sortProperty = "date")
@OATable(indexes = {
...
public class OrderContact extends OAObject {
	...
	public void followupDateCallback(OAObjectCallback em) {
	}
	...
	@OAObjCallback(enabledProperty = OrderContact.P_Followup)
	public void followupTimeCallback(OAObjectCallback em) {
	}
	...
	@OAObjCallback(enabledProperty = OrderContact.P_Followup)
	public void followupNoteCallback(OAObjectCallback em) {
	}
	...
	@OAObjCallback(enabledProperty = OrderContact.P_Followup)
	public void followupCompletedCallback(OAObjectCallback em) {
	}

	@OAOne(reverseName = Contact.P_OrderContacts)
	...
	@OAOne(reverseName = Order.P_OrderContacts, required = true, allowCreateNew = false)
	...
	public void load(ResultSet rs, int id) throws SQLException {
		...
		date = rs.getDate(6);
		if (date != null) {
			this.followupDate = new OADate(date);
		}
		time = rs.getTime(7);
		if (time != null) {
			this.followupTime = new OATime(time);
		}
