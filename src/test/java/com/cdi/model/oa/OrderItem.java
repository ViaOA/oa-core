...
@OAClass(shortName = "oi", displayName = "Order Item", displayProperty = "item", sortProperty = "item")
@OATable(indexes = {
...
public class OrderItem extends OAObject {
	...
	public void onHandQuantityCallback(OAObjectCallback em) {
	}
	...
	@OAObjCallback(enabledProperty = OrderItem.P_IsProduced)
	public void shippedQuantityCallback(OAObjectCallback em) {
	}
	...
	public String getNotes() {
		if (notes != null) {
			notes = OAString.convertTextToHTML(notes, false);
		}
		return notes;
	}
	...
	@OAObjCallback(enabledProperty = OrderItem.P_IsProduced)
	public void expectedProductionEndDateCallback(OAObjectCallback em) {
	}
	...
	@OACalculatedProperty(displayName = "Minimum Days", description = "number of days that it will take to produce the qty for this item, based on mold count", displayLength = 6, columnLength = 9, columnName = "Mini Days", properties = {
			P_Quantity, P_Item + "." + Item.P_Mold + "." + Mold.P_OnHand })
	public int getCalcMinimumDays() {
		...
		if (onHand <= 0) {
			return 99; // per Nathan's request
		}
	...
	@OACalculatedProperty(displayName = "Remaining", displayLength = 6, columnLength = 10, columnName = "Remain Qty", properties = {
			P_Quantity, P_OnHandQuantity, P_ShippedQuantity })
	...
	@OACalculatedProperty(displayName = "Is Valid Quantity", displayLength = 2, columnLength = 9, columnName = "Valid Qty", properties = {
			P_Quantity, P_WOItems + "." + WOItem.P_Quantity, P_IsProduced, P_Item, P_ShippedQuantity, P_OnHandQuantity,
			P_Order + "." + Order.P_IsOpen })
	public boolean getIsValidQuantity() {
		...
		if (b && (getQuantity() < (getShippedQuantity() + getOnHandQuantity()))) {
			b = false;
		}
		return b;
	}

	@OACalculatedProperty(displayName = "Work Order Quantity", displayLength = 6, columnName = "WO Qty", properties = {
			P_WOItems + "." + WOItem.P_Quantity })
	...
	@OACalculatedProperty(displayName = "Unshipped Qty", displayLength = 6, columnLength = 13, properties = { P_Quantity,
			P_ShippedQuantity })
	...
	@OAOne(displayName = "Item", isCalculated = true, reverseName = Item.P_OpenOrderItems, allowCreateNew = false, allowAddExisting = false)
	private Item getGroupByItem() {
		// oamodel has createMethod set to false, this method exists only for annotations.
		return null;
	}

	@OAOne(reverseName = Item.P_OrderItems, required = true, isProcessed = true, allowCreateNew = false)
	...
	@OAOne(reverseName = Order.P_OrderItems, required = true, isProcessed = true, allowCreateNew = false)
	...
	@OAMany(displayName = "Order Item Comments", toClass = OrderItemComment.class, owner = true, reverseName = OrderItemComment.P_OrderItem, cascadeSave = true, cascadeDelete = true)
	...
	@OAMany(displayName = "Work Order Items", toClass = WOItem.class, reverseName = WOItem.P_OrderItem, isProcessed = true, cascadeSave = true, cascadeDelete = true)
	...
	@OAObjCallback(enabledProperty = OrderItem.P_IsProduced)
	public void wOItemsCallback(OAObjectCallback em) {
	}
