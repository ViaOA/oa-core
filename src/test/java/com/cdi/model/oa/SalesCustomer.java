...
@OAClass(shortName = "sc", displayName = "Sales Customer", displayProperty = "name", sortProperty = "name")
@OATable(indexes = {
...
public class SalesCustomer extends OAObject {
	...
	public String getNote() {
		if (note != null) {
			note = OAString.convertTextToHTML(note, false);
		}
		return note;
	}
	...
	@OAOne(reverseName = Customer.P_SalesCustomers, allowCreateNew = false)
	...
	@OAOne(displayName = "Sales Order", reverseName = SalesOrder.P_SalesCustomer, allowCreateNew = false, mustBeEmptyForDelete = true)
	...
	@OAOne(displayName = "Ship To", reverseName = ShipTo.P_SalesCustomers, cascadeSave = true, cascadeDelete = true, autoCreateNew = true, allowAddExisting = false)
	...
	@OAObjCallback(enabledProperty = SalesCustomer.P_SalesOrder + "." + SalesOrder.P_CustomerPickUp, enabledValue = false)
	public void shipToCallback(OAObjectCallback em) {
	}
	...
	public void updateSalesCustomerCallback(OAObjectCallback em) {
	}
