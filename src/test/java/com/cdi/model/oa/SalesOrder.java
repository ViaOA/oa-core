...
import com.cdi.delegate.oa.SalesOrderDelegate;
import com.cdi.model.oa.filter.SalesOrderOpenFilter;
import com.cdi.model.oa.filter.SalesOrderSalesPersonFilter;
import com.cdi.model.oa.method.SalesOrderCloseMethod;
...
@OAClass(shortName = "so", displayName = "Sales Order", displayProperty = "display", sortProperty = "date", filterClasses = {
		SalesOrderOpenFilter.class, SalesOrderSalesPersonFilter.class })
@OATable(indexes = {
...
public class SalesOrder extends OAObject {
	...
	@OAObjCallback(enabledProperty = SalesOrder.P_CanEdit, contextEnabledProperty = AppUser.P_User + "."
			+ User.P_CalcSalesWriteAccess, viewDependentProperties = { SalesOrder.P_SalesOrderItems })
	public void callback(OAObjectCallback em) {
		...
		case AfterCopy:
			...
			break;
		case AllowDelete:
			if (em.getValue() instanceof SalesOrder) {
				em.setAllowed(getSalesOrderItems().size() == 0);
			}
			break;
		case SetConfirmForDelete:
		case VerifyDelete:
			if (getSalesOrderItems().size() == 0) {
				break;
			}
	...
	public void closeReasonCallback(OAObjectCallback em) {
	}
	...
	public void discountPercentCallback(OAObjectCallback em) {
	}
	...
	public void submitErrorCallback(OAObjectCallback em) {
	}

	@OACalculatedProperty(displayName = "Total Item Our Price", decimalPlaces = 2, isCurrency = true, displayLength = 9, columnLength = 14, columnName = "Tot Item Our $", properties = {
			P_SalesOrderItems + "." + SalesOrderItem.P_TotalItemOurPrice })
	...
	@OACalculatedProperty(displayName = "Total Item Sell Price", decimalPlaces = 2, isCurrency = true, displayLength = 9, columnLength = 10, columnName = "Tot Item $", properties = {
			P_SalesOrderItems + "." + SalesOrderItem.P_TotalItemSellPrice })
	...
	@OACalculatedProperty(displayName = "Total Item Discount", decimalPlaces = 2, isCurrency = true, displayLength = 8, columnLength = 12, columnName = "Total Disc $", properties = {
			P_DiscountPercent, P_TotalItemSellPrice })
	...
	@OAObjCallback(visibleProperty = SalesOrder.P_DiscountPercent)
	public void totalItemDiscountCallback(OAObjectCallback em) {
	}

	@OACalculatedProperty(displayName = "Total Tooling", decimalPlaces = 2, isCurrency = true, displayLength = 9, columnName = "Tot Tool$", properties = {
			P_SalesOrderItems + "." + SalesOrderItem.P_ServicePrice })
	...
	@OACalculatedProperty(displayName = "Total Before Tax", decimalPlaces = 2, isCurrency = true, displayLength = 9, columnLength = 14, columnName = "Tot before tax", properties = {
			P_TotalService, P_TotalItemSellPrice, P_TotalItemDiscount })
	...
	@OACalculatedProperty(displayName = "Total Tax", decimalPlaces = 2, isCurrency = true, displayLength = 9, columnLength = 8, columnName = "Tot Tax", properties = {
			P_TotalBeforeTax, P_TaxRate })
	...
	@OACalculatedProperty(displayName = "Total With Tax", decimalPlaces = 2, isCurrency = true, displayLength = 9, columnLength = 14, properties = {
			P_TotalTax, P_TotalBeforeTax })
	...
	@OACalculatedProperty(displayName = "Total Order", decimalPlaces = 2, isCurrency = true, displayLength = 9, columnLength = 11, properties = {
			P_TotalWithTax, P_ShippingPrice })
	...
	@OACalculatedProperty(displayName = "Total Weight", displayLength = 8, columnName = "Total Wt", properties = {
			P_SalesOrderItems + "." + SalesOrderItem.P_TotalWeight })
	public int getTotalWeight() {
		return SalesOrderDelegate.getTotalWeight(this);
	}

	@OACalculatedProperty(displayName = "Current Date Status", displayLength = 15, columnLength = 11, columnName = "Status", properties = {
			P_DateSubmitted, P_DateComplete, P_DateClosed })
	public String getCurrentDateStatus() {
		return SalesOrderDelegate.getCurrentDateStatus(this);
	}

	@OACalculatedProperty(displayName = "Last Follow Up", displayLength = 12, properties = {
			P_SalesOrderNotes + "." + SalesOrderNote.P_FollowupDate })
	public OADate getLastFollowUp() {
		return SalesOrderDelegate.getLastFollowUp(this);
	}

	@OACalculatedProperty(displayLength = 18, columnLength = 32, properties = { P_Project, P_SalesPersonUser + "." + User.P_FullName,
			P_SalesCustomer + "." + SalesCustomer.P_Name })
	...
	@OACalculatedProperty(displayName = "Followup Date", displayLength = 8, properties = {
			P_SalesOrderNotes + "." + SalesOrderNote.P_FollowupDate, P_SalesOrderNotes + "." + SalesOrderNote.P_FollowedUp })
	public OADate getCalcFollowupDate() {
		OADate d = null;
		for (SalesOrderNote salesOrderNote : getSalesOrderNotes()) {
			if (salesOrderNote.getFollowedUp()) {
				continue;
			}
			OADate d2 = salesOrderNote.getFollowupDate();
			if (d2 != null && (d == null || d2.before(d))) {
				d = d2;
			}
		}
		return d;
	...
	@OAOne(displayName = "Assigned User", reverseName = User.P_AssignedSalesOrders, allowCreateNew = false)
	...
	@OAOne(reverseName = Order.P_SalesOrder, isProcessed = true, allowCreateNew = false, allowAddExisting = false)
	...
	public void orderCallback(OAObjectCallback em) {
	}

	@OAOne(displayName = "Price Code", reverseName = PriceCode.P_SalesOrders, allowCreateNew = false)
	...
	@OAOne(displayName = "Sales Customer", owner = true, reverseName = SalesCustomer.P_SalesOrder, required = true, cascadeSave = true, cascadeDelete = true, autoCreateNew = true, allowAddExisting = false)
	...
	@OAMany(displayName = "Sales Order Items", toClass = SalesOrderItem.class, owner = true, reverseName = SalesOrderItem.P_SalesOrder, cascadeSave = true, cascadeDelete = true, mustBeEmptyForDelete = true, seqProperty = SalesOrderItem.P_Seq, sortProperty = SalesOrderItem.P_Seq)
	...
	@OAMany(displayName = "Sales Order Notes", toClass = SalesOrderNote.class, owner = true, reverseName = SalesOrderNote.P_SalesOrder, cascadeSave = true, cascadeDelete = true, sortProperty = SalesOrderNote.P_Created)
	...
	@OAOne(displayName = "Sales Order Source", reverseName = SalesOrderSource.P_SalesOrders, allowCreateNew = false)
	...
	@OAOne(displayName = "Sales Order Status", reverseName = SalesOrderStatus.P_SalesOrders, allowCreateNew = false)
	...
	@OAOne(displayName = "Sales Person", reverseName = User.P_SalesPersonSalesOrders, allowCreateNew = false)
	...
	public void submitToQuickBooks() {
		if (!verifyCommand(M_SubmitToQuickBooks)) {
			throw new RuntimeException("verify command returned false");
		}
		this.setDateSubmitted(new OADate());
		this.setDateClosed(new OADate());
	}

	@OAObjCallback(enabledProperty = SalesOrder.P_DateSubmitted, enabledValue = false, viewDependentProperties = {
			SalesOrder.P_DateClosed })
	...
	@OAObjCallback(visibleProperty = SalesOrder.P_DateClosed, viewDependentProperties = { SalesOrder.P_DateSubmitted,
			SalesOrder.P_DateClosed }, contextDependentProperties = { AppUser.P_Admin, AppUser.P_User + "." + User.P_AdminAccess })
	...
	public void load(ResultSet rs, int id) throws SQLException {
		...
		date = rs.getDate(4);
		if (date != null) {
			this.dateExpected = new OADate(date);
		}
		date = rs.getDate(5);
		if (date != null) {
			this.dateSubmitted = new OADate(date);
		}
		date = rs.getDate(6);
		if (date != null) {
			this.dateProcessed = new OADate(date);
		}
		date = rs.getDate(7);
		if (date != null) {
			this.dateComplete = new OADate(date);
		}
		date = rs.getDate(8);
		if (date != null) {
			this.dateClosed = new OADate(date);
		}
		...
		date = rs.getDate(16);
		if (date != null) {
			this.lastRevisedDate = new OADate(date);
		}
		this.lastRevisedNote = rs.getString(17);
		date = rs.getDate(18);
		if (date != null) {
			this.bidDate = new OADate(date);
		}
