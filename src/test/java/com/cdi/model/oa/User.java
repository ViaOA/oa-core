...
import com.cdi.model.oa.filter.UserActiveFilter;
import com.cdi.model.oa.filter.UserAssignedProdFilter;
import com.cdi.model.oa.filter.UserAssignedSalesFilter;
import com.cdi.model.oa.filter.UserInspectorFilter;
import com.cdi.model.oa.filter.UserSalesPersonFilter;
 ...
 */
@OAClass(shortName = "use", displayName = "User", description = "Updated by ServerController._getUser at login.", isLookup = true, isPreSelect = true, displayProperty = "fullName", sortProperty = "lastName", estimatedTotal = 20, filterClasses = {
		UserSalesPersonFilter.class, UserActiveFilter.class, UserInspectorFilter.class, UserAssignedProdFilter.class,
		UserAssignedSalesFilter.class })
@OATable(name = "UserTable", indexes = {
...
public class User extends OAObject {
	...
	public void inactiveDateCallback(OAObjectCallback em) {
	}
	...
	@OAObjCallback(contextEnabledProperty = AppUser.P_Admin)
	public void newOrderAccessCallback(OAObjectCallback em) {
	}
	...
	@OAObjCallback(contextEnabledProperty = AppUser.P_Admin)
	public void adminAccessCallback(OAObjectCallback em) {
	}
	...
	@OAObjCallback(contextEnabledProperty = AppUser.P_Admin)
	public void prodViewAccessCallback(OAObjectCallback em) {
	}
	...
	@OAObjCallback(contextEnabledProperty = AppUser.P_Admin)
	public void prodShippingAccessCallback(OAObjectCallback em) {
	}
	...
	@OAObjCallback(contextEnabledProperty = AppUser.P_Admin)
	public void prodManagerAccessCallback(OAObjectCallback em) {
	}
	...
	@OAObjCallback(contextEnabledProperty = AppUser.P_Admin)
	public void salesViewAccessCallback(OAObjectCallback em) {
	}
	...
	@OAObjCallback(contextEnabledProperty = AppUser.P_Admin)
	public void salesUserAccessCallback(OAObjectCallback em) {
	}
	...
	@OAObjCallback(contextEnabledProperty = AppUser.P_Admin)
	public void prodAssignedToListCallback(OAObjectCallback em) {
	}
	...
	@OAObjCallback(contextEnabledProperty = AppUser.P_Admin)
	public void salesAssignedToListCallback(OAObjectCallback em) {
	}
	...
	@OAObjCallback(contextEnabledProperty = AppUser.P_Admin)
	public void salesPersonListCallback(OAObjectCallback em) {
	}
	...
	@OAObjCallback(contextEnabledProperty = AppUser.P_Admin)
	public void prodInspectorListCallback(OAObjectCallback em) {
	}
	...
	@OAObjCallback(contextEnabledProperty = AppUser.P_Admin)
	public void salesAccessCallback(OAObjectCallback em) {
	}
	...
	@OAObjCallback(contextEnabledProperty = AppUser.P_Admin)
	public void productionAccessCallback(OAObjectCallback em) {
	}
	...
	@OAObjCallback(contextEnabledProperty = AppUser.P_Admin)
	public void customerAccessCallback(OAObjectCallback em) {
	}
	...
	@OAObjCallback(contextEnabledProperty = AppUser.P_Admin)
	public void itemAccessCallback(OAObjectCallback em) {
	}
	...
	@OAObjCallback(contextEnabledProperty = AppUser.P_Admin)
	public void pricingAccessCallback(OAObjectCallback em) {
	}
	...
	@OAObjCallback(contextEnabledProperty = AppUser.P_Admin)
	public void searchAccessCallback(OAObjectCallback em) {
	}
	...
	@OACalculatedProperty(displayName = "Calc Admin Access", displayLength = 5, columnLength = 17, properties = { P_AdminAccess,
			P_AppUser + "." + AppUser.P_Admin })
	...
	@OACalculatedProperty(displayName = "Production Access", displayLength = 5, columnLength = 11, columnName = "Prod Access", properties = {
			P_ProductionAccess, P_AdminAccess, P_AppUser + "." + AppUser.P_Admin })
	...
	@OACalculatedProperty(displayName = "Calc Production Write Access", displayLength = 5, columnLength = 28, properties = { P_AdminAccess,
			P_ProductionAccess, P_AppUser + "." + AppUser.P_Admin })
	...
	@OACalculatedProperty(displayName = "Sales Read Access", displayLength = 5, columnLength = 17, properties = { P_AdminAccess,
			P_SalesAccess, P_AppUser + "." + AppUser.P_Admin })
	...
	@OACalculatedProperty(displayName = "Sales Write Access", displayLength = 5, columnLength = 18, properties = { P_AdminAccess,
			P_SalesAccess, P_AppUser + "." + AppUser.P_Admin })
	...
	@OACalculatedProperty(displayName = "Calc Customer Read Access", displayLength = 5, columnLength = 25, properties = { P_CalcAdminAccess,
			P_CustomerAccess })
	...
	@OACalculatedProperty(displayName = "Calc Customer Write Access", displayLength = 5, columnLength = 26, properties = {
			P_CalcAdminAccess, P_CustomerAccess })
	...
	@OACalculatedProperty(displayName = "Calc Item Read Access", displayLength = 5, columnLength = 21, properties = { P_CalcAdminAccess,
			P_ItemAccess })
	public boolean getCalcItemReadAccess() {
		if (this.getCalcAdminAccess()) {
			return true;
		}
	...
	@OACalculatedProperty(displayName = "Calc Item Write Access", displayLength = 5, columnLength = 22, properties = { P_CalcAdminAccess,
			P_ItemAccess })
	...
	@OACalculatedProperty(displayName = "Calc Pricing Read Access", displayLength = 5, columnLength = 24, properties = { P_CalcAdminAccess,
			P_PricingAccess })
	...
	@OACalculatedProperty(displayName = "Calc Pricing Write Access", displayLength = 5, columnLength = 25, properties = { P_CalcAdminAccess,
			P_PricingAccess })
	...
	@OACalculatedProperty(displayName = "Calc Search Read Access", displayLength = 5, columnLength = 23, properties = { P_CalcAdminAccess,
			P_SearchAccess })
	...
	@OACalculatedProperty(displayName = "Calc Search Write Access", displayLength = 5, columnLength = 24, properties = { P_CalcAdminAccess,
			P_SearchAccess })
	...
	@OAOne(displayName = "App User", reverseName = AppUser.P_User, isProcessed = true, allowCreateNew = false, allowAddExisting = false)
	...
	public void appUserCallback(OAObjectCallback em) {
	}

	@OAMany(displayName = "Assigned Sales Orders", toClass = SalesOrder.class, reverseName = SalesOrder.P_AssignedUser)
	...
	@OAMany(displayName = "Assigned Work Orders", toClass = WorkOrder.class, reverseName = WorkOrder.P_AssignedUsers, createMethod = false)
	...
	@OAMany(displayName = "Inspect Work Orders", toClass = WorkOrder.class, reverseName = WorkOrder.P_InspectUser, createMethod = false)
	private Hub<WorkOrder> getInspectWorkOrders() {
		// oamodel has createMethod set to false, this method exists only for annotations.
		return null;
	}

	@OAMany(displayName = "Order Notes", toClass = OrderNote.class, reverseName = OrderNote.P_User, isProcessed = true, createMethod = false)
	private Hub<OrderNote> getOrderNotes() {
		// oamodel has createMethod set to false, this method exists only for annotations.
		return null;
	}

	@OAMany(displayName = "Sales Order Notes", toClass = SalesOrderNote.class, reverseName = SalesOrderNote.P_User, isProcessed = true, createMethod = false)
	private Hub<SalesOrderNote> getSalesOrderNotes() {
		// oamodel has createMethod set to false, this method exists only for annotations.
		return null;
	}

	@OAMany(displayName = "Sales Person Sales Orders", toClass = SalesOrder.class, reverseName = SalesOrder.P_SalesPersonUser, createMethod = false)
	...
	@OAObjCallback(contextVisibleProperty = AppUser.P_Admin)
	public void updateAppUserCallback(OAObjectCallback em) {
	}
	...
	public void load(ResultSet rs, int id) throws SQLException {
		...
		date = rs.getDate(2);
		if (date != null) {
			this.dateCreated = new OADate(date);
		}
