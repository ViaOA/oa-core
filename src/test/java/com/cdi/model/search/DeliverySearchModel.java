...
public class DeliverySearchModel {
    ...
    protected DeliverySearch deliverySearch;
    ...
    public DeliverySearch getDeliverySearch() {
        if (deliverySearch != null) return deliverySearch;
    ...
    public TruckSearchModel getTruckSearchModel() {
        if (modelTruckSearch == null) {
            ...
            getDeliverySearch().setTruckSearch(modelTruckSearch.getTruckSearch());
        }
    ...
    public OrderSearchModel getOrderSearchModel() {
        if (modelOrderSearch == null) {
            ...
            getDeliverySearch().setOrderSearch(modelOrderSearch.getOrderSearch());
        }
