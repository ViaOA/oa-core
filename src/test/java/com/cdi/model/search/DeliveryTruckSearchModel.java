...
public class DeliveryTruckSearchModel {
    ...
    protected DeliveryTruckSearch deliveryTruckSearch;
    ...
    public DeliveryTruckSearch getDeliveryTruckSearch() {
        if (deliveryTruckSearch != null) return deliveryTruckSearch;
        deliveryTruckSearch = new DeliveryTruckSearch();
    ...
    public TruckSearchModel getWOTruckTruckSearchModel() {
        if (modelWOTruckTruckSearch == null) {
            ...
            getDeliveryTruckSearch().setWOTruckTruckSearch(modelWOTruckTruckSearch.getTruckSearch());
        }
    ...
    public WorkOrderSearchModel getWODeliveriesWorkOrderSearchModel() {
        if (modelWODeliveriesWorkOrderSearch == null) {
            ...
            getDeliveryTruckSearch().setWODeliveriesWorkOrderSearch(modelWODeliveriesWorkOrderSearch.getWorkOrderSearch());
        }
