...
public class ImageStoreSearchModel {
    ...
    protected ImageStoreSearch searchImageStore;
    ...
    public ImageStoreSearch getImageStoreSearch() {
        if (searchImageStore != null) return searchImageStore;
        searchImageStore = new ImageStoreSearch();
        return searchImageStore;
    }
