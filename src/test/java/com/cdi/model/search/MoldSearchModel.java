...
public class MoldSearchModel {
    ...
    protected MoldSearch moldSearch;
    ...
    public MoldSearch getMoldSearch() {
        if (moldSearch != null) return moldSearch;
        moldSearch = new MoldSearch();
        return moldSearch;
    }
    ...
    public ItemSearchModel getMoldItemsSearchModel() {
        if (modelMoldItemsSearch == null) {
            ...
            getMoldSearch().setMoldItemsSearch(modelMoldItemsSearch.getItemSearch());
        }
