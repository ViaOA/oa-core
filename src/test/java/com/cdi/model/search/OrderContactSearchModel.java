...
public class OrderContactSearchModel {
    ...
    protected OrderContactSearch orderContactSearch;
    ...
    public OrderContactSearch getOrderContactSearch() {
        if (orderContactSearch != null) return orderContactSearch;
        orderContactSearch = new OrderContactSearch();
        return orderContactSearch;
    }
    ...
    public OrderSearchModel getOrderContactOrderSearchModel() {
        if (modelOrderContactOrderSearch == null) {
            ...
            getOrderContactSearch().setOrderContactOrderSearch(modelOrderContactOrderSearch.getOrderSearch());
        }
    ...
    public ContactSearchModel getContactSearchModel() {
        if (modelContactSearch == null) {
            ...
            getOrderContactSearch().setContactSearch(modelContactSearch.getContactSearch());
        }
