...
public class OrderItemCommentSearchModel {
    ...
    protected OrderItemCommentSearch orderItemCommentSearch;
    ...
    public OrderItemCommentSearch getOrderItemCommentSearch() {
        if (orderItemCommentSearch != null) return orderItemCommentSearch;
        orderItemCommentSearch = new OrderItemCommentSearch();
        return orderItemCommentSearch;
    }
    ...
    public OrderSearchModel getOrderItemOrderSearchModel() {
        if (modelOrderItemOrderSearch == null) {
            ...
            getOrderItemCommentSearch().setOrderItemOrderSearch(modelOrderItemOrderSearch.getOrderSearch());
        }
    ...
    public ItemSearchModel getOrderItemItemSearchModel() {
        if (modelOrderItemItemSearch == null) {
            ...
            getOrderItemCommentSearch().setOrderItemItemSearch(modelOrderItemItemSearch.getItemSearch());
        }
