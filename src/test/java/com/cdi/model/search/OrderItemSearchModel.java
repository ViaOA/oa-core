...
public class OrderItemSearchModel {
    ...
    protected OrderItemSearch orderItemSearch;
    ...
    public OrderItemSearch getOrderItemSearch() {
        if (orderItemSearch != null) return orderItemSearch;
        orderItemSearch = new OrderItemSearch();
        return orderItemSearch;
    }
    ...
    public ItemSearchModel getOrderItemItemSearchModel() {
        if (modelOrderItemItemSearch == null) {
            ...
            getOrderItemSearch().setOrderItemItemSearch(modelOrderItemItemSearch.getItemSearch());
        }
    ...
    public OrderSearchModel getOrderItemOrderSearchModel() {
        if (modelOrderItemOrderSearch == null) {
            ...
            getOrderItemSearch().setOrderItemOrderSearch(modelOrderItemOrderSearch.getOrderSearch());
        }
