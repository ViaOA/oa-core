...
public class OrderNoteSearchModel {
    ...
    protected OrderNoteSearch orderNoteSearch;
    ...
    public OrderNoteSearch getOrderNoteSearch() {
        if (orderNoteSearch != null) return orderNoteSearch;
        orderNoteSearch = new OrderNoteSearch();
        return orderNoteSearch;
    }
    ...
    public OrderSearchModel getOrderNoteOrderSearchModel() {
        if (modelOrderNoteOrderSearch == null) {
            ...
            getOrderNoteSearch().setOrderNoteOrderSearch(modelOrderNoteOrderSearch.getOrderSearch());
        }
    ...
    public UserSearchModel getOrderNoteUserSearchModel() {
        if (modelOrderNoteUserSearch == null) {
            ...
            getOrderNoteSearch().setOrderNoteUserSearch(modelOrderNoteUserSearch.getUserSearch());
        }
