...
public class SalesCustomerSearchModel {
    ...
    protected SalesCustomerSearch salesCustomerSearch;
    ...
    public SalesCustomerSearch getSalesCustomerSearch() {
        if (salesCustomerSearch != null) return salesCustomerSearch;
        salesCustomerSearch = new SalesCustomerSearch();
        return salesCustomerSearch;
    }
    ...
    public SalesOrderSearchModel getSalesCustomerSalesOrderSearchModel() {
        if (modelSalesCustomerSalesOrderSearch == null) {
            ...
            getSalesCustomerSearch().setSalesCustomerSalesOrderSearch(modelSalesCustomerSalesOrderSearch.getSalesOrderSearch());
        }
