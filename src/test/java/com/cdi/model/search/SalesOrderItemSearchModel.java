...
public class SalesOrderItemSearchModel {
    ...
    protected SalesOrderItemSearch salesOrderItemSearch;
    ...
    public SalesOrderItemSearch getSalesOrderItemSearch() {
        if (salesOrderItemSearch != null) return salesOrderItemSearch;
        salesOrderItemSearch = new SalesOrderItemSearch();
        return salesOrderItemSearch;
    }
    ...
    public SalesOrderSearchModel getSalesOrderItemSalesOrderSearchModel() {
        if (modelSalesOrderItemSalesOrderSearch == null) {
            ...
            getSalesOrderItemSearch().setSalesOrderItemSalesOrderSearch(modelSalesOrderItemSalesOrderSearch.getSalesOrderSearch());
        }
    ...
    public ServiceCodeSearchModel getSalesOrderItemServiceCodeSearchModel() {
        if (modelSalesOrderItemServiceCodeSearch == null) {
            ...
            getSalesOrderItemSearch().setSalesOrderItemServiceCodeSearch(modelSalesOrderItemServiceCodeSearch.getServiceCodeSearch());
        }
    ...
    public ItemSearchModel getSalesOrderItemItemSearchModel() {
        if (modelSalesOrderItemItemSearch == null) {
            ...
            getSalesOrderItemSearch().setSalesOrderItemItemSearch(modelSalesOrderItemItemSearch.getItemSearch());
        }
