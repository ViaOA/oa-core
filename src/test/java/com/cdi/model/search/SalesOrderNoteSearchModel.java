...
public class SalesOrderNoteSearchModel {
    ...
    protected SalesOrderNoteSearch salesOrderNoteSearch;
    ...
    public SalesOrderNoteSearch getSalesOrderNoteSearch() {
        if (salesOrderNoteSearch != null) return salesOrderNoteSearch;
        salesOrderNoteSearch = new SalesOrderNoteSearch();
        return salesOrderNoteSearch;
    }
    ...
    public UserSearchModel getSalesOrderNoteUserSearchModel() {
        if (modelSalesOrderNoteUserSearch == null) {
            ...
            getSalesOrderNoteSearch().setSalesOrderNoteUserSearch(modelSalesOrderNoteUserSearch.getUserSearch());
        }
    ...
    public SalesOrderSearchModel getSalesOrderNoteSalesOrderSearchModel() {
        if (modelSalesOrderNoteSalesOrderSearch == null) {
            ...
            getSalesOrderNoteSearch().setSalesOrderNoteSalesOrderSearch(modelSalesOrderNoteSalesOrderSearch.getSalesOrderSearch());
        }
