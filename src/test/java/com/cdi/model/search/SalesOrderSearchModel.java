...
public class SalesOrderSearchModel {
    ...
    protected SalesOrderSearch salesOrderSearch;
    ...
    public SalesOrderSearch getSalesOrderSearch() {
        if (salesOrderSearch != null) return salesOrderSearch;
        salesOrderSearch = new SalesOrderSearch();
    ...
    public UserSearchModel getSalesOrderSalesPersonUserSearchModel() {
        if (modelSalesOrderSalesPersonUserSearch == null) {
            ...
            getSalesOrderSearch().setSalesOrderSalesPersonUserSearch(modelSalesOrderSalesPersonUserSearch.getUserSearch());
        }
    ...
    public SalesCustomerSearchModel getSalesCustomerSearchModel() {
        if (modelSalesCustomerSearch == null) {
            ...
            getSalesOrderSearch().setSalesCustomerSearch(modelSalesCustomerSearch.getSalesCustomerSearch());
        }
    ...
    public CustomerSearchModel getSalesCustomerCustomerSearchModel() {
        if (modelSalesCustomerCustomerSearch == null) {
            ...
            getSalesOrderSearch().setSalesCustomerCustomerSearch(modelSalesCustomerCustomerSearch.getCustomerSearch());
        }
    ...
    public ItemSearchModel getSalesOrderItemsItemSearchModel() {
        if (modelSalesOrderItemsItemSearch == null) {
            ...
            getSalesOrderSearch().setSalesOrderItemsItemSearch(modelSalesOrderItemsItemSearch.getItemSearch());
        }
