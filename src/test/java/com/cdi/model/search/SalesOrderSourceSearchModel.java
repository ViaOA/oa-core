...
public class SalesOrderSourceSearchModel {
    ...
    protected SalesOrderSourceSearch salesOrderSourceSearch;
    ...
    public SalesOrderSourceSearch getSalesOrderSourceSearch() {
        if (salesOrderSourceSearch != null) return salesOrderSourceSearch;
        salesOrderSourceSearch = new SalesOrderSourceSearch();
        return salesOrderSourceSearch;
    }
