...
public class ShipToSearchModel {
    ...
    protected ShipToSearch shipToSearch;
    ...
    public ShipToSearch getShipToSearch() {
        if (shipToSearch != null) return shipToSearch;
        shipToSearch = new ShipToSearch();
        return shipToSearch;
    }
    ...
    public OrderSearchModel getShipToOrdersSearchModel() {
        if (modelShipToOrdersSearch == null) {
            ...
            getShipToSearch().setShipToOrdersSearch(modelShipToOrdersSearch.getOrderSearch());
        }
    ...
    public SalesCustomerSearchModel getShipToSalesCustomersSearchModel() {
        if (modelShipToSalesCustomersSearch == null) {
            ...
            getShipToSearch().setShipToSalesCustomersSearch(modelShipToSalesCustomersSearch.getSalesCustomerSearch());
        }
