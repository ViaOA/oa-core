...
public class WOItemSearchModel {
    ...
    protected WOItemSearch woItemSearch;
    ...
    public WOItemSearch getWOItemSearch() {
        if (woItemSearch != null) return woItemSearch;
        woItemSearch = new WOItemSearch();
        return woItemSearch;
    }
    ...
    public ItemSearchModel getOrderItemItemSearchModel() {
        if (modelOrderItemItemSearch == null) {
            ...
            getWOItemSearch().setOrderItemItemSearch(modelOrderItemItemSearch.getItemSearch());
        }
    ...
    public WorkOrderSearchModel getWOItemWorkOrderSearchModel() {
        if (modelWOItemWorkOrderSearch == null) {
            ...
            getWOItemSearch().setWOItemWorkOrderSearch(modelWOItemWorkOrderSearch.getWorkOrderSearch());
        }
