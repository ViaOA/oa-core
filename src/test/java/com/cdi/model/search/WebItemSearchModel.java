...
public class WebItemSearchModel {
    ...
    protected WebItemSearch webItemSearch;
    ...
    public WebItemSearch getWebItemSearch() {
        if (webItemSearch != null) return webItemSearch;
        webItemSearch = new WebItemSearch();
        return webItemSearch;
    }
    ...
    public ItemSearchModel getItemSearchModel() {
        if (modelItemSearch == null) {
            ...
            getWebItemSearch().setItemSearch(modelItemSearch.getItemSearch());
        }
