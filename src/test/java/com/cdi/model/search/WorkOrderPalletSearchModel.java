...
public class WorkOrderPalletSearchModel {
    ...
    protected WorkOrderPalletSearch workOrderPalletSearch;
    ...
    public WorkOrderPalletSearch getWorkOrderPalletSearch() {
        if (workOrderPalletSearch != null) return workOrderPalletSearch;
        workOrderPalletSearch = new WorkOrderPalletSearch();
        return workOrderPalletSearch;
    }
    ...
    public WorkOrderSearchModel getWorkOrderPalletWorkOrderSearchModel() {
        if (modelWorkOrderPalletWorkOrderSearch == null) {
            ...
            getWorkOrderPalletSearch().setWorkOrderPalletWorkOrderSearch(modelWorkOrderPalletWorkOrderSearch.getWorkOrderSearch());
        }
    ...
    public OrderSearchModel getWorkOrderOrderSearchModel() {
        if (modelWorkOrderOrderSearch == null) {
            ...
            getWorkOrderPalletSearch().setWorkOrderOrderSearch(modelWorkOrderOrderSearch.getOrderSearch());
        }
    ...
    public PalletSearchModel getWorkOrderPalletPalletSearchModel() {
        if (modelWorkOrderPalletPalletSearch == null) {
            ...
            getWorkOrderPalletSearch().setWorkOrderPalletPalletSearch(modelWorkOrderPalletPalletSearch.getPalletSearch());
        }
