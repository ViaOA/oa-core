...
public class WorkOrderSearchModel {
    ...
    protected WorkOrderSearch workOrderSearch;
    ...
    public WorkOrderSearch getWorkOrderSearch() {
        if (workOrderSearch != null) return workOrderSearch;
    ...
    public OrderSearchModel getWorkOrderOrderSearchModel() {
        if (modelWorkOrderOrderSearch == null) {
            ...
            getWorkOrderSearch().setWorkOrderOrderSearch(modelWorkOrderOrderSearch.getOrderSearch());
        }
    ...
    public ItemSearchModel getOrderItemItemSearchModel() {
        if (modelOrderItemItemSearch == null) {
            ...
            getWorkOrderSearch().setOrderItemItemSearch(modelOrderItemItemSearch.getItemSearch());
        }
