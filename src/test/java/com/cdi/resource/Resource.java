...
public class Resource {
    ...
    public static final String QBWC_Enabled          = "qbwc.enabled";
    public static final String QBWC_Url              = "qbwc.url";
	...
	*/
    ...
    public static OAProperties getBundleProperties() {
        ...
        try {
            InputStream resourceAsStream = OAObject.class.getResourceAsStream("/META-INF/maven/com.cdi/cdI3/pom.properties");
    ...
    protected static void resetLocaleDefaults() {
        ...
        if (s == null || s.length() == 0) s = ("true;false;false");
