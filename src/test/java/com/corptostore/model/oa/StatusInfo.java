...
public class StatusInfo extends OAObject {
	...
	public static final String P_TransmitBatchInfo = "transmitBatchInfo";
	...
	public void setObjectDefaults() {
		...
		getStoreInfo(); // have it autoCreated
	}
	...
	@OAProperty(maxLength = 250, displayLength = 20, columnLength = 15, hasCustomCode = true)
	...
	@OAProperty(displayName = "Last Status", displayLength = 15, isProcessed = true)
	...
	@OAProperty(displayName = "Status Count", displayLength = 6, columnLength = 12, isProcessed = true)
	...
	@OAProperty(displayName = "Last Alert", displayLength = 15, isProcessed = true)
	...
	@OAProperty(displayName = "Alert Count", displayLength = 6, columnLength = 11, isProcessed = true)
	...
	@OAProperty(displayName = "Last Activity", displayLength = 15, isProcessed = true)
	...
	@OAProperty(displayName = "Activity Count", displayLength = 6, columnLength = 14, isProcessed = true)
	...
	@OAOne(displayName = "Corp To Store", reverseName = CorpToStore.P_StatusInfo, allowCreateNew = false, allowAddExisting = false, isOneAndOnlyOne = true)
	private CorpToStore getCorpToStore() {
		// oamodel has createMethod set to false, this method exists only for annotations.
		return null;
	}

	@OAOne(displayName = "Purge Window", reverseName = PurgeWindow.P_StatusInfo, allowCreateNew = false, allowAddExisting = false)
	private PurgeWindow getPurgeWindow() {
		// oamodel has createMethod set to false, this method exists only for annotations.
		return null;
	}

	@OAMany(displayName = "Activity Messages", toClass = StatusInfoMessage.class, reverseName = StatusInfoMessage.P_StatusInfoActivity, isProcessed = true)
	...
	@OAMany(displayName = "Alert Messages", toClass = StatusInfoMessage.class, reverseName = StatusInfoMessage.P_StatusInfoAlert, isProcessed = true)
	...
	@OAMany(displayName = "Status Info Messages", toClass = StatusInfoMessage.class, owner = true, reverseName = StatusInfoMessage.P_StatusInfo, isProcessed = true, cascadeSave = true, cascadeDelete = true)
	...
	@OAOne(displayName = "Store Info", reverseName = StoreInfo.P_StatusInfo, allowCreateNew = false, autoCreateNew = true, allowAddExisting = false, isOneAndOnlyOne = true)
	private StoreInfo getStoreInfo() {
		// oamodel has createMethod set to false, this method exists only for annotations.
		return null;
	}

	@OAOne(displayName = "Store Lock Info", reverseName = StoreLockInfo.P_StatusInfo, allowCreateNew = false, allowAddExisting = false, isOneAndOnlyOne = true)
	private StoreLockInfo getStoreLockInfo() {
		// oamodel has createMethod set to false, this method exists only for annotations.
		return null;
	}

	@OAOne(displayName = "Store Lock Service Info", reverseName = StoreLockServiceInfo.P_StatusInfo, allowCreateNew = false, allowAddExisting = false, isOneAndOnlyOne = true)
	private StoreLockServiceInfo getStoreLockServiceInfo() {
		// oamodel has createMethod set to false, this method exists only for annotations.
		return null;
	}
	...
	@OAOne(displayName = "Transmit Batch Info", reverseName = TransmitBatchInfo.P_StatusInfo, allowCreateNew = false, allowAddExisting = false, isOneAndOnlyOne = true)
	private TransmitBatchInfo getTransmitBatchInfo() {
		// oamodel has createMethod set to false, this method exists only for annotations.
		return null;
	}

	@OAOne(displayName = "Transmit Batch Service Info", reverseName = TransmitBatchServiceInfo.P_StatusInfo, allowCreateNew = false, allowAddExisting = false, isOneAndOnlyOne = true)
	private TransmitBatchServiceInfo getTransmitBatchServiceInfo() {
		// oamodel has createMethod set to false, this method exists only for annotations.
		return null;
	}
}
