...
public class StatusInfoMessage extends OAObject {
	...
	@OAProperty(defaultValue = "new OADateTime()", displayLength = 15, columnLength = 18, format = "MM/dd hh:mm:ss.S", isProcessed = true)
	...
	@OAOne(displayName = "Status Info", reverseName = StatusInfo.P_StatusInfoMessages, required = true, isProcessed = true, allowCreateNew = false, allowAddExisting = false)
	...
	@OAOne(displayName = "Status Info", reverseName = StatusInfo.P_StatusInfoActivityMessages, isProcessed = true, allowCreateNew = false, allowAddExisting = false)
	...
	@OAOne(displayName = "Status Info", reverseName = StatusInfo.P_StatusInfoAlertMessages, isProcessed = true, allowCreateNew = false, allowAddExisting = false)
