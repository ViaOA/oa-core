...
import com.messagedesigner.model.oa.Test;
...
@OATable()
public class Test extends OAObject {
	...
	public static final String PROPERTY_SourceAsString = "SourceString";
	...
	public static final String PROPERTY_RpgMessageDefinitionFile = "RpgMessageDefinitionFile";
	public static final String P_RpgMessageDefinitionFile = "RpgMessageDefinitionFile";
	public static final String PROPERTY_CommonApiRootDirectory = "CommonApiRootDirectory";
	public static final String P_CommonApiRootDirectory = "CommonApiRootDirectory";

	public static final String PROPERTY_ApiCode = "ApiCode";
	public static final String P_ApiCode = "ApiCode";
	public static final String PROPERTY_ControllerCode = "ControllerCode";
	public static final String P_ControllerCode = "ControllerCode";

	public static final String PROPERTY_MessageTypeRecords = "MessageTypeRecords";
	public static final String P_MessageTypeRecords = "MessageTypeRecords";
	public static final String PROPERTY_MessageTypes = "MessageTypes";
	public static final String P_MessageTypes = "MessageTypes";

	public static final String METHOD_SortMessageTypes = "SortMessageTypes";
	public static final String M_SortMessageTypes = "SortMessageTypes";
	public static final String METHOD_CreateOneMessageTypeForRecords = "CreateOneMessageTypeForRecords";
	...
	public static final String METHOD_RefreshApiCode = "RefreshApiCode";
	public static final String M_RefreshApiCode = "RefreshApiCode";
	public static final String METHOD_RefreshControllerCode = "RefreshControllerCode";
	public static final String M_RefreshControllerCode = "RefreshControllerCode";
	public static final String METHOD_LoadRpgMessageFile = "LoadRpgMessageFile";
	public static final String M_LoadRpgMessageFile = "LoadRpgMessageFile";
	public static final String METHOD_ClearMessages = "ClearMessages";
	public static final String M_ClearMessages = "ClearMessages";
	public static final String METHOD_ExportApiAndClasses = "ExportApiAndClasses";
	public static final String M_ExportApiAndClasses = "ExportApiAndClasses";
	public static final String METHOD_SaveAsJsonResource = "SaveAsJsonResource";
	public static final String M_SaveAsJsonResource = "SaveAsJsonResource";
	public static final String METHOD_SaveAsCSV = "SaveAsCSV";
	public static final String M_SaveAsCSV = "SaveAsCSV";
	public static final String METHOD_VerifyAll = "VerifyAll";
	...
	public String getApiCode() {
		return null; // MessageSourceDelegate.getApiCode(this);
	}

	@OACalculatedProperty(displayName = "Controller Code", displayLength = 30, columnLength = 20)
	public String getControllerCode() {
		return null; // MessageSourceDelegate.getControllerCode(this);
	}
	...
	public void refreshApiCode() {
		firePropertyChange(PROPERTY_ApiCode);
	}

	@OAMethod(displayName = "Refresh Controller Code")
	public void refreshControllerCode() {
		firePropertyChange(PROPERTY_ControllerCode);
	}
	...
	@OAObjCallback(enabledProperty = Test.P_RpgMessageDefinitionFile)
	...
	public void load(ResultSet rs, int id) throws SQLException {
		...
		if (rs.wasNull()) {
			OAObjectInfoDelegate.setPrimitiveNull(this, Test.P_Source, true);
		}
