...
@OAClass(
    lowerName = "messageType",
    pluralName = "MessageTypes",
    shortName = "mst",
    displayName = "Message Type",
    displayProperty = "display",
    sortProperty = "display",
    filterClasses = {MessageTypeChangedFilter.class, MessageTypeNotVerifiedFilter.class}
)
@OATable(
    indexes = {
...
public class MessageType extends OAObject {
    ...
    */
    ...
    @OACalculatedProperty(displayLength = 15, properties = {P_Name, P_MessageRecords+"."+MessageRecord.P_MessageTypeRecord+"."+MessageTypeRecord.P_Code})
    public String getDisplay() {
        ...
        if (codes != null) display += codes;
        display += ")";
        return display;
    }
    @OACalculatedProperty(displayName = "Record Codes", displayLength = 20, properties = {P_MessageRecords+"."+MessageRecord.P_MessageTypeRecord+"."+MessageTypeRecord.P_Code})
    ...
    @OACalculatedProperty(displayName = "Pojo Code", displayLength = 30, columnLength = 20, properties = {P_Name, P_MessageRecords+"."+MessageRecord.P_RelationshipType, P_MessageRecords+"."+MessageRecord.P_MessageTypeRecord+"."+MessageTypeRecord.P_PojoCode})
    public String getPojoCode() {
        String pojo = MessageTypeDelegate.getPojoCode(this);
        return pojo;
    }
    @OACalculatedProperty(displayName = "API Name", displayLength = 14, properties = {P_Name, P_MessageRecords+"."+MessageRecord.P_RelationshipType})
    ...
    @OAMany(
        ...
        toClass = MessageGroup.class, 
        owner = true, 
        reverseName = MessageGroup.P_MessageType, 
        cascadeSave = true, 
        cascadeDelete = true
    )
    ...
    @OAMany(
        ...
        owner = true, 
        reverseName = MessageRecord.P_MessageType, 
        cascadeSave = true, 
        cascadeDelete = true, 
        seqProperty = MessageRecord.P_Seq, 
        sortProperty = MessageRecord.P_Seq
    )
    ...
    @OAMany(
        toClass = Message.class, 
        reverseName = Message.P_MessageType, 
        createMethod = false
    )
    ...
    @OAOne(
        ...
        reverseName = MessageSource.P_MessageTypes, 
        required = true, 
    ...
    @OAMany(
        displayName = "Message Type Changes", 
        toClass = MessageTypeChange.class, 
        reverseName = MessageTypeChange.P_MessageType, 
        isProcessed = true
    )
