...
public class AppUser extends OAObject {
    ...
    @OAProperty(displayName = "Super Admin", trackPrimitiveNull = false, displayLength = 5, columnLength = 11)
    ...
    @OAProperty(displayName = "Edit Processed", trackPrimitiveNull = false, displayLength = 5)
    @OAColumn(sqlType = java.sql.Types.BOOLEAN)
