...
public class Garage extends OAObject {
    private static final long serialVersionUID = 1L;
    private static Logger LOG = Logger.getLogger(Garage.class.getName());
    ...
    protected transient Hub<GarageVehicle> hubGarageVehicles;
    ...
    @OAMany(
        ...
        owner = true, 
        reverseName = GarageVehicle.P_Garage, 
        cascadeSave = true, 
        cascadeDelete = true
    )
    public Hub<GarageVehicle> getGarageVehicles() {
        if (hubGarageVehicles == null) {
            hubGarageVehicles = (Hub<GarageVehicle>) getHub(P_GarageVehicles);
        }
        return hubGarageVehicles;
    }
