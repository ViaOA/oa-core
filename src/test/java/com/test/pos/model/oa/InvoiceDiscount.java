...
@OAClass(
    lowerName = "invoiceDiscount",
    pluralName = "InvoiceDiscounts",
    shortName = "ind",
...
public class InvoiceDiscount extends OAObject {
    private static final long serialVersionUID = 1L;
    private static Logger LOG = Logger.getLogger(InvoiceDiscount.class.getName());
    ...
    public static final int TYPE_fixedAmount = 1;
    ...
    @OAProperty(lowerName = "percentage", decimalPlaces = 2, displayLength = 7, uiColumnLength = 10)
    @OAColumn(name = "Percentage", sqlType = java.sql.Types.DOUBLE)
    public double getPercentage() {
        return percentage;
    }
    public void setPercentage(double newValue) {
        double old = percentage;
        fireBeforePropertyChange(P_Percentage, old, newValue);
        this.percentage = newValue;
        firePropertyChange(P_Percentage, old, this.percentage);
    }
    public void load(ResultSet rs, int id) throws SQLException {
        ...
        this.percentage = rs.getDouble(6);
        setPrimitiveNull(P_Percentage, rs.wasNull());
