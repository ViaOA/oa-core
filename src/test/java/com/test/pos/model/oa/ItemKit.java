...
@OATable(
    indexes = {
        @OAIndex(name = "ItemKitItem", fkey = true, columns = { @OAIndexColumn(name = "ItemId") })
    }
)
public class ItemKit extends OAObject {
    private static final long serialVersionUID = 1L;
    private static Logger LOG = Logger.getLogger(ItemKit.class.getName());
