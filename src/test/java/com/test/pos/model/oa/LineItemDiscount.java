...
@OAClass(
    lowerName = "lineItemDiscount",
    pluralName = "LineItemDiscounts",
    shortName = "lid",
    displayName = "Line Item Discount",
    displayProperty = "id",
    noPojo = true
)
@OATable(
)
public class LineItemDiscount extends OAObject {
    private static final long serialVersionUID = 1L;
    private static Logger LOG = Logger.getLogger(LineItemDiscount.class.getName());
    ...
    public LineItemDiscount(int id) {
        this();
        setId(id);
    }
    ...
    public void load(ResultSet rs, int id) throws SQLException {
        ...
        this.percentage = rs.getDouble(4);
