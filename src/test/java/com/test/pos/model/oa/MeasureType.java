...
@OAClass(
    lowerName = "measureType",
    pluralName = "MeasureTypes",
    shortName = "mst",
...
public class MeasureType extends OAObject {
    private static final long serialVersionUID = 1L;
    private static Logger LOG = Logger.getLogger(MeasureType.class.getName());
    ...
    public static final int TYPE_WidthHeight = 4;
    public static final int TYPE_Volumn = 5;
