...
/**
  Created at startup by ObjectController, so that each Report one-link has a ReportClass to represent it.
*/
@OAClass(
    ...
    description = "Created at startup by ObjectController, so that each Report one-link has a ReportClass to represent it.",
    isLookup = true,
    isPreSelect = true,
    isProcessed = true,
