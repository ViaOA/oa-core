...
public class VehicleMake extends OAObject {
    private static final long serialVersionUID = 1L;
    private static Logger LOG = Logger.getLogger(VehicleMake.class.getName());
    ...
    @OAMany(
        ...
        owner = true, 
        reverseName = VehicleModel.P_VehicleMake, 
        cascadeSave = true, 
        cascadeDelete = true
    )
