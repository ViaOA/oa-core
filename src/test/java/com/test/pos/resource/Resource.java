...
public class Resource {
    ...
    public static final String APP_ReplicationMasterHostName = "replicationMasterHostName";
    public static final String APP_ReplicationMasterPort = "replicationMasterPort";
	...
	public static OAProperties getBundleProperties() {
		...
		try {
			InputStream resourceAsStream = OAObject.class.getResourceAsStream("/META-INF/maven/com.viaoa.pos/oapos/pom.properties");
