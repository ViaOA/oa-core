...
class OAArrayExtraTest {
    ...
    void removeValueHandlesObjectValuesButCurrentlyDoesNotRemoveNullOrPrimitiveValues() {
        ...
        assertArrayEquals(new int[] { 1, 3 }, OAArray.removeValue(new int[] { 1, 2, 3 }, 2));
        assertArrayEquals(new double[] { 1.0d, 3.0d }, OAArray.removeValue(new double[] { 1.0d, 2.0d, 3.0d }, 2.0d));
    }
