...
class OALinkInfoTest {
    ...
    void simpleFlagAndStringAccessorsRoundTrip() throws Exception {
        ...
        link.setModelUserEnabledProperty("ctxEnabled");
        link.setModelUserEnabledValue(false);
        link.setModelUserVisibleProperty("ctxVisible");
        ...
        assertEquals("ctxEnabled", link.getModelUserEnabledProperty());
        assertFalse(link.getModelUserEnabledValue());
        assertEquals("ctxVisible", link.getModelUserVisibleProperty());
