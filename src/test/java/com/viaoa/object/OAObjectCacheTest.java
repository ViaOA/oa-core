...
public class OAObjectCacheTest extends OAUnitTest {
	...
	public void cacheGetTest() {
		...
		OAObjectKey ok = server.getObjectKey();
		
		Object[] ids = ok.getObjectIds();
		assertTrue(ids != null && ids.length == 1 && ids[0] == null);
		
		Server serverx = OAObjectCacheDelegate.get(Server.class, 0);
