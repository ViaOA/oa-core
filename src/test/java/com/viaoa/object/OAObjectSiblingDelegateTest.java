...
public class OAObjectSiblingDelegateTest extends OAUnitTest {
	...
	public void test() throws Exception {
		...
		assertEquals(0, oks == null ? 0 : oks.length);
	...
	public void test2() throws Exception {
		...
		assertEquals(ai.get() - 1, oks == null ? 0 : oks.length);
	...
	public void test3() throws Exception {
		...
		final AtomicInteger ai = new AtomicInteger();
		OAFinder<Program, AddOnItem> f = new OAFinder<Program, AddOnItem>(
				ProgramPP.locations().employees().employeeAwards().awardType().addOnItems().pp) {
			int id = 999;
