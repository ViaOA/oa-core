...
import test.hifive.model.oa.AddressType;
import test.hifive.model.oa.Answer;
import test.hifive.model.oa.AnswerResult;
import test.hifive.model.oa.AwardCardOrder;
import test.hifive.model.oa.AwardType;
import test.hifive.model.oa.Card;
import test.hifive.model.oa.CardVendor;
import test.hifive.model.oa.CashstarOrder;
import test.hifive.model.oa.Catalog;
import test.hifive.model.oa.Charity;
import test.hifive.model.oa.Company;
import test.hifive.model.oa.CountryCode;
import test.hifive.model.oa.CurrencyType;
import test.hifive.model.oa.CustomData;
import test.hifive.model.oa.Ecard;
import test.hifive.model.oa.EcardCategory;
import test.hifive.model.oa.Email;
import test.hifive.model.oa.EmailType;
import test.hifive.model.oa.Employee;
import test.hifive.model.oa.EmployeeAward;
import test.hifive.model.oa.EmployeeAwardCharity;
import test.hifive.model.oa.EmployeeCustomData;
import test.hifive.model.oa.EmployeeEcard;
import test.hifive.model.oa.EmployeeEcardTo;
import test.hifive.model.oa.EmployeeSurvey;
import test.hifive.model.oa.EmployeeSurveyQuestion;
import test.hifive.model.oa.EmployeeType;
import test.hifive.model.oa.HindaOrder;
import test.hifive.model.oa.HindaOrderLine;
import test.hifive.model.oa.ImageStore;
import test.hifive.model.oa.Inspire;
import test.hifive.model.oa.InspireApproval;
import test.hifive.model.oa.InspireAwardLevel;
import test.hifive.model.oa.InspireAwardLevelLocationValue;
import test.hifive.model.oa.InspireCoreValue;
import test.hifive.model.oa.InspireOrder;
import test.hifive.model.oa.InspireOrderCharity;
import test.hifive.model.oa.InspireOrderItem;
import test.hifive.model.oa.InspireRecipient;
import test.hifive.model.oa.Item;
import test.hifive.model.oa.ItemCategory;
import test.hifive.model.oa.ItemType;
import test.hifive.model.oa.ItemVendor;
import test.hifive.model.oa.Location;
import test.hifive.model.oa.LocationPageGroup;
import test.hifive.model.oa.LocationPageInfo;
import test.hifive.model.oa.LocationType;
import test.hifive.model.oa.LoginImage;
import test.hifive.model.oa.LoginImageSet;
import test.hifive.model.oa.Merchant;
import test.hifive.model.oa.MerchantCategory;
import test.hifive.model.oa.OrderItemTracking;
import test.hifive.model.oa.OrderTracking;
import test.hifive.model.oa.OrderTrackingStatus;
import test.hifive.model.oa.Page;
import test.hifive.model.oa.PageGroup;
import test.hifive.model.oa.PageGroupPageInfo;
import test.hifive.model.oa.PageInfo;
import test.hifive.model.oa.PageTheme;
import test.hifive.model.oa.PageThemePageInfo;
import test.hifive.model.oa.Phone;
import test.hifive.model.oa.PhoneType;
import test.hifive.model.oa.PointsApproval;
import test.hifive.model.oa.PointsAwardLevel;
import test.hifive.model.oa.PointsConfiguration;
import test.hifive.model.oa.PointsCoreValue;
import test.hifive.model.oa.PointsRecord;
import test.hifive.model.oa.PointsRequest;
import test.hifive.model.oa.Product;
import test.hifive.model.oa.ProductAudit;
import test.hifive.model.oa.Program;
import test.hifive.model.oa.ProgramDocument;
import test.hifive.model.oa.ProgramEmailType;
import test.hifive.model.oa.ProgramEvent;
import test.hifive.model.oa.ProgramFaq;
import test.hifive.model.oa.ProgramPageGroup;
import test.hifive.model.oa.ProgramPageInfo;
import test.hifive.model.oa.Question;
import test.hifive.model.oa.QuestionResult;
import test.hifive.model.oa.Quiz;
import test.hifive.model.oa.QuizResult;
import test.hifive.model.oa.Report;
import test.hifive.model.oa.ReportClass;
import test.hifive.model.oa.Section;
import test.hifive.model.oa.ShipTo;
import test.hifive.model.oa.Survey;
import test.hifive.model.oa.SurveyAnswer;
import test.hifive.model.oa.SurveyQuestion;
import test.hifive.model.oa.User;
import test.hifive.model.oa.Value;
import test.hifive.model.oa.Widget;
...
public class DataSource {
	...
	private Database createDatabase() {
		...
		tables[INSPIREAWARDLEVEL].addLink(	"inspireAwardLevelLocationValues", tables[INSPIREAWARDLEVELLOCATIONVALUE], "inspireAwardLevel",
											new int[] { 0 });
		...
		tables[INSPIREAWARDLEVELLOCATIONVALUE].addLink(	"inspireAwardLevel", tables[INSPIREAWARDLEVEL], "inspireAwardLevelLocationValues",
														new int[] { 2 });
		tables[INSPIREAWARDLEVELLOCATIONVALUE].addLink(	"inspireRecipients", tables[INSPIRERECIPIENT], "inspireAwardLevelLocationValue",
														new int[] { 0 });
		...
		tables[INSPIRERECIPIENT].addLink(	"inspireAwardLevelLocationValue", tables[INSPIREAWARDLEVELLOCATIONVALUE], "inspireRecipients",
											new int[] { 7 });
	...
	*/
	...
	protected EmployeeSurveyQuestion getEmployeeSurveyQuestion(ResultSet rs, DataAccessObject.ResultSetInfo rsi) throws SQLException {
		int id = rs.getInt(1);
		EmployeeSurveyQuestion employeeSurveyQuestion = (EmployeeSurveyQuestion) OAObjectCacheDelegate
				.getObject(EmployeeSurveyQuestion.class, id);
	...
	*/
	...
	protected InspireAwardLevelLocationValue getInspireAwardLevelLocationValue(ResultSet rs, DataAccessObject.ResultSetInfo rsi)
			throws SQLException {
		int id = rs.getInt(1);
		InspireAwardLevelLocationValue inspireAwardLevelLocationValue = (InspireAwardLevelLocationValue) OAObjectCacheDelegate
				.getObject(InspireAwardLevelLocationValue.class, id);
