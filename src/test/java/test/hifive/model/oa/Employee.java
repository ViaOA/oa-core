...
import com.viaoa.hub.filter.FilteredHub;
...
public class Employee extends OAObject {
	...
	public void employeeCodeCallback(OAObjectCallback eq) {
		if (TestEditQuery_EmployeeCode == null) {
			return;
		}
	...
	@OAObjCallback()
	public void lastNameCallback(OAObjectCallback eq) {
		if (eq == null) {
			return;
		}
	...
	@OAObjCallback()
	public void inactiveDateCallback(OAObjectCallback eq) {
		if (eq == null) {
			return;
		}
		if (eq.getType() == Type.VerifyPropertyChange) {
	...
	*/
	...
	@OAObjCallback
	public void employeeAwardsCallback(OAObjectCallback eq) {
		if (validateTestType == 3) {
			eq.setAllowed(false);
			return;
		}
	...
	public static void employeeAwardsModelCallback(OAObjectModel om) {
	}
	...
	public void locationCallback(OAObjectCallback eq) {
		if (TestEditQuery_Location == null) {
			return;
		}
	...
	public void commandCallback(OAObjectCallback eq) {
