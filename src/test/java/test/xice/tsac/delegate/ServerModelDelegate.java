...
import test.xice.tsac.model.oa.AdminUser;
import test.xice.tsac.model.oa.ConnectionInfo;
import test.xice.tsac.model.oa.ExceptionType;
import test.xice.tsac.model.oa.IniInfo;
import test.xice.tsac.model.oa.ServerInfo;
import test.xice.tsac.model.oa.SystemInfo;
...
// qqqq not currently used     
    ...
    public static AdminUser getRemoteAdminUser() {
        ...
        RequestInfo ri = null;//qqqqqqqqq OAThreadLocalDelegate.getRemoteRequestInfo();
