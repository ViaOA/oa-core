...
public class ApplicationTypeCommand extends OAObject {
	...
	@OAOne(displayName = "Application Type", reverseName = ApplicationType.P_ApplicationTypeCommands, required = true, allowCreateNew = false, importMatch = true)
	...
	@OAOne(reverseName = Command.P_ApplicationTypeCommands, required = true, allowCreateNew = false, importMatch = true)
