...
public class Developer extends OAObject {
	...
	@OAProperty(displayName = "First Name", maxLength = 35, displayLength = 12, columnLength = 8, importMatch = true)
	...
	@OAProperty(displayName = "Last Name", maxLength = 55, displayLength = 12, columnLength = 8, importMatch = true)
