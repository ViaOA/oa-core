...
@OAClass(shortName = "os", displayName = "Operating System", isLookup = true, isPreSelect = true, displayProperty = "name")
@OATable()
public class OperatingSystem extends OAObject {
	...
	@OAProperty(displayLength = 12, columnLength = 7, isNameValue = true, importMatch = true)
	@OAColumn(sqlType = java.sql.Types.INTEGER)
	public int getType() {
		return type;
	}
	...
	@OAMany(displayName = "OS Versions", toClass = OSVersion.class, owner = true, reverseName = OSVersion.P_OperatingSystem, cascadeSave = true, cascadeDelete = true)
