...
@OAClass(shortName = "pt", displayName = "Package Type", isLookup = true, isPreSelect = true, displayProperty = "code")
@OATable()
public class PackageType extends OAObject {
	...
	@OAProperty(maxLength = 14, isUnique = true, displayLength = 8, columnLength = 6, importMatch = true)
	...
	@OAMany(displayName = "Application Types", toClass = ApplicationType.class, reverseName = ApplicationType.P_PackageTypes)
	...
	@OAMany(displayName = "Application Versions", toClass = ApplicationVersion.class, reverseName = ApplicationVersion.P_PackageType, createMethod = false)
	private Hub<ApplicationVersion> getApplicationVersions() {
		// oamodel has createMethod set to false, this method exists only for annotations.
		return null;
	}

	@OAMany(displayName = "Package Versions", toClass = PackageVersion.class, owner = true, reverseName = PackageVersion.P_PackageType, cascadeSave = true, cascadeDelete = true)
	...
	@OAMany(displayName = "Silo Config Versioins", toClass = SiloConfigVersioin.class, reverseName = SiloConfigVersioin.P_PackageType, createMethod = false)
